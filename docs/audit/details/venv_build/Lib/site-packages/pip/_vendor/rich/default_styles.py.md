# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/rich/default_styles.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/rich/default_styles.py`
- **Tipo de archivo:** `.py`
