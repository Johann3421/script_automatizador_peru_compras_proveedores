# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/resolvelib/compat/collections_abc.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/resolvelib/compat/collections_abc.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 6
