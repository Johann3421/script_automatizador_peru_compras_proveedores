# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/urllib3/_version.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/urllib3/_version.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 2
