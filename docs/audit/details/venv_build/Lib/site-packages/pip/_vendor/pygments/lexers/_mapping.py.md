# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/pygments/lexers/_mapping.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/pygments/lexers/_mapping.py`
- **Tipo de archivo:** `.py`
