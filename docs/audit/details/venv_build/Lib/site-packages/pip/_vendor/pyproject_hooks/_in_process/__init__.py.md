# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/pyproject_hooks/_in_process/__init__.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/pyproject_hooks/_in_process/__init__.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
