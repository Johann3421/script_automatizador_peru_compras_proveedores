# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/truststore/__init__.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/truststore/__init__.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 36
