# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/rich/_windows.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/rich/_windows.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 71
...
#### Clase `WindowsConsoleFeatures` (Línea 6)
- **Docstring:** _Windows features available._
