# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/rich/_cell_widths.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/rich/_cell_widths.py`
- **Tipo de archivo:** `.py`
