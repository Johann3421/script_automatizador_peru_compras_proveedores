# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/rich/_spinners.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/rich/_spinners.py`
- **Tipo de archivo:** `.py`
