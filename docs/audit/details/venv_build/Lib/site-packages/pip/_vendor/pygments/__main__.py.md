# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/pygments/__main__.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/pygments/__main__.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 17
