# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/distlib/__init__.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/distlib/__init__.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 33
...
#### Clase `DistlibException` (Línea 12)
