# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/rich/_export_format.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/rich/_export_format.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 76
