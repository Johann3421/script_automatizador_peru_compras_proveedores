# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/rich/_palettes.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/rich/_palettes.py`
- **Tipo de archivo:** `.py`
