# Documentación Técnica: `venv_build/Lib/site-packages/pip/_vendor/pyproject_hooks/_compat.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_vendor/pyproject_hooks/_compat.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 8
