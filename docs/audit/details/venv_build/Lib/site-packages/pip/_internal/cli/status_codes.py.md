# Documentación Técnica: `venv_build/Lib/site-packages/pip/_internal/cli/status_codes.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_internal/cli/status_codes.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 6
