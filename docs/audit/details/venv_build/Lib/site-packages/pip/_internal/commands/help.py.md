# Documentación Técnica: `venv_build/Lib/site-packages/pip/_internal/commands/help.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pip/_internal/commands/help.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 41
...
#### Clase `HelpCommand` (Línea 9)
- **Docstring:** _Show help for commands_
- **Métodos:**
  - `def run(self, options, args)` (Línea 16): Sin docstring.
