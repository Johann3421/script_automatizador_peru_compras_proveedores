# Documentación Técnica: `venv_build/Lib/site-packages/setuptools/config/__init__.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/setuptools/config/__init__.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 43
...
#### `def _deprecation_notice(fn)` (Línea 16)
- **Propósito:** Sin docstring.
- **Firma:** `def _deprecation_notice(fn)`
