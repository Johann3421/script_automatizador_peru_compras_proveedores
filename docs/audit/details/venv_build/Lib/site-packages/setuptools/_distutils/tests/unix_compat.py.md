# Documentación Técnica: `venv_build/Lib/site-packages/setuptools/_distutils/tests/unix_compat.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/setuptools/_distutils/tests/unix_compat.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 17
