# Documentación Técnica: `venv_build/Lib/site-packages/setuptools/_distutils/compat/numpy.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/setuptools/_distutils/compat/numpy.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 2
