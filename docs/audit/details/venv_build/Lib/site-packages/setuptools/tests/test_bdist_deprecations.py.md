# Documentación Técnica: `venv_build/Lib/site-packages/setuptools/tests/test_bdist_deprecations.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/setuptools/tests/test_bdist_deprecations.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 28
...
#### `def test_bdist_rpm_warning(distutils_cmd, tmpdir_cwd)` (Línea 15)
- **Propósito:** Sin docstring.
- **Firma:** `def test_bdist_rpm_warning(distutils_cmd, tmpdir_cwd)`
