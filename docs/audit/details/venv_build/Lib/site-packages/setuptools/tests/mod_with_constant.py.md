# Documentación Técnica: `venv_build/Lib/site-packages/setuptools/tests/mod_with_constant.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/setuptools/tests/mod_with_constant.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 1
