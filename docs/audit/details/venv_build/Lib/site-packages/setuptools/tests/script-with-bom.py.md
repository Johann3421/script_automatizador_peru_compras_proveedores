# Documentación Técnica: `venv_build/Lib/site-packages/setuptools/tests/script-with-bom.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/setuptools/tests/script-with-bom.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 1
