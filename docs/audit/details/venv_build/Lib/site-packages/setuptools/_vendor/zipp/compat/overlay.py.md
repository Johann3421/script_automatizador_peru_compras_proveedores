# Documentación Técnica: `venv_build/Lib/site-packages/setuptools/_vendor/zipp/compat/overlay.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/setuptools/_vendor/zipp/compat/overlay.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 37
...
#### Clase `HashableNamespace` (Línea 28)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def __hash__(self)` (Línea 29): Sin docstring.
