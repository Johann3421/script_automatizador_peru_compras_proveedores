# Documentación Técnica: `venv_build/Lib/site-packages/setuptools/_vendor/wheel/bdist_wheel.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/setuptools/_vendor/wheel/bdist_wheel.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 26
