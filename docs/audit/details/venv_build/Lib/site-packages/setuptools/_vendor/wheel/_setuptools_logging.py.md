# Documentación Técnica: `venv_build/Lib/site-packages/setuptools/_vendor/wheel/_setuptools_logging.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/setuptools/_vendor/wheel/_setuptools_logging.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 26
...
#### `def _not_warning(record)` (Línea 8)
- **Propósito:** Sin docstring.
- **Firma:** `def _not_warning(record)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def configure()` (Línea 12)
- **Propósito:** Configure logging to emit warning and above to stderr
