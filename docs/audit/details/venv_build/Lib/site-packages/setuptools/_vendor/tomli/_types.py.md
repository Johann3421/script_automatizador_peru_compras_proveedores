# Documentación Técnica: `venv_build/Lib/site-packages/setuptools/_vendor/tomli/_types.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/setuptools/_vendor/tomli/_types.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 10
