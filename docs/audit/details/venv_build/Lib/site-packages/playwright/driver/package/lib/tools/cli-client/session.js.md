# Documentación Técnica: `venv_build/Lib/site-packages/playwright/driver/package/lib/tools/cli-client/session.js`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/driver/package/lib/tools/cli-client/session.js`
- **Tipo de archivo:** `.js`
