# Documentación Técnica: `venv_build/Lib/site-packages/playwright/driver/package/lib/entry/dashboardApp.js`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/driver/package/lib/entry/dashboardApp.js`
- **Tipo de archivo:** `.js`
- **Líneas de código:** 3
