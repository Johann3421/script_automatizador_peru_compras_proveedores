# Documentación Técnica: `venv_build/Lib/site-packages/playwright/driver/package/cli.js`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/driver/package/cli.js`
- **Tipo de archivo:** `.js`
- **Líneas de código:** 21
