# Documentación Técnica: `venv_build/Lib/site-packages/playwright/driver/package/lib/vite/dashboard/assets/index-DpEq2p62.js`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/driver/package/lib/vite/dashboard/assets/index-DpEq2p62.js`
- **Tipo de archivo:** `.js`
- **Líneas de código:** 52
