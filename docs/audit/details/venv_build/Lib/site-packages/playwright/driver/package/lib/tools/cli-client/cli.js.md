# Documentación Técnica: `venv_build/Lib/site-packages/playwright/driver/package/lib/tools/cli-client/cli.js`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/driver/package/lib/tools/cli-client/cli.js`
- **Tipo de archivo:** `.js`
- **Líneas de código:** 6
