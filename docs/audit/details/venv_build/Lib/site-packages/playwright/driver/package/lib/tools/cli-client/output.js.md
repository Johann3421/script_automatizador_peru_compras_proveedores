# Documentación Técnica: `venv_build/Lib/site-packages/playwright/driver/package/lib/tools/cli-client/output.js`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/driver/package/lib/tools/cli-client/output.js`
- **Tipo de archivo:** `.js`
