# Documentación Técnica: `venv_build/Lib/site-packages/playwright/driver/package/lib/serverRegistry.js`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/driver/package/lib/serverRegistry.js`
- **Tipo de archivo:** `.js`
- **Líneas de código:** 7343
