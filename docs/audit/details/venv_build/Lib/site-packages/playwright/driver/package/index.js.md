# Documentación Técnica: `venv_build/Lib/site-packages/playwright/driver/package/index.js`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/driver/package/index.js`
- **Tipo de archivo:** `.js`
- **Líneas de código:** 32
