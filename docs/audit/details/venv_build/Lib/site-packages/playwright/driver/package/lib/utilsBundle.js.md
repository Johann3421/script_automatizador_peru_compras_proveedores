# Documentación Técnica: `venv_build/Lib/site-packages/playwright/driver/package/lib/utilsBundle.js`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/driver/package/lib/utilsBundle.js`
- **Tipo de archivo:** `.js`
- **Líneas de código:** 85418
