# Documentación Técnica: `venv_build/Lib/site-packages/playwright/driver/package/lib/entry/oopBrowserDownload.js`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/driver/package/lib/entry/oopBrowserDownload.js`
- **Tipo de archivo:** `.js`
- **Líneas de código:** 3
