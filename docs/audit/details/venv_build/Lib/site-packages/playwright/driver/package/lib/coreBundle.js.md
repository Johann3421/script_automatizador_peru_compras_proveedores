# Documentación Técnica: `venv_build/Lib/site-packages/playwright/driver/package/lib/coreBundle.js`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/driver/package/lib/coreBundle.js`
- **Tipo de archivo:** `.js`
- **Líneas de código:** 69799
