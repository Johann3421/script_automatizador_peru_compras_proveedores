# Documentación Técnica: `venv_build/Lib/site-packages/playwright/driver/package/lib/vite/recorder/assets/codeMirrorModule-BHYmBp6h.js`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/driver/package/lib/vite/recorder/assets/codeMirrorModule-BHYmBp6h.js`
- **Tipo de archivo:** `.js`
- **Líneas de código:** 32
