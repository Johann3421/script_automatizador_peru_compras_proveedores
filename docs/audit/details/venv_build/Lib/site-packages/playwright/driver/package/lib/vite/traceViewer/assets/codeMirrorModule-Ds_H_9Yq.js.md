# Documentación Técnica: `venv_build/Lib/site-packages/playwright/driver/package/lib/vite/traceViewer/assets/codeMirrorModule-Ds_H_9Yq.js`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/driver/package/lib/vite/traceViewer/assets/codeMirrorModule-Ds_H_9Yq.js`
- **Tipo de archivo:** `.js`
- **Líneas de código:** 32
