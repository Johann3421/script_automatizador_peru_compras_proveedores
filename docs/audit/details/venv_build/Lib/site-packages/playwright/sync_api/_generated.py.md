# Documentación Técnica: `venv_build/Lib/site-packages/playwright/sync_api/_generated.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/sync_api/_generated.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 23456
- **Fecha de inspección:** 2026-08-05 18:36:35
...
#### Clase `Request` (Línea 99)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def url(self)` (Línea 102): Request.url
...
-------
str
  - `def resource_type(self)` (Línea 114): Request.resource_type
...
-------
str
  - `def service_worker(self)` (Línea 128): Request.service_worker
...
-------
Union[Worker, None]
  - `def method(self)` (Línea 146): Request.method
...
-------
str
  - `def post_data(self)` (Línea 158): Request.post_data
...
-------
Union[str, None]
  - `def post_data_json(self)` (Línea 170): Request.post_data_json
...
-------
Union[Any, None]
  - `def post_data_buffer(self)` (Línea 185): Request.post_data_buffer
...
-------
Union[bytes, None]
  - `def existing_response(self)` (Línea 197): Request.existing_response
...
-------
Union[Response, None]
  - `def frame(self)` (Línea 212): Request.frame
...
-------
Frame
  - `def redirected_from(self)` (Línea 239): Request.redirected_from
...
-------
Union[Request, None]
  - `def redirected_to(self)` (Línea 271): Request.redirected_to
...
-------
Union[Request, None]
  - `def failure(self)` (Línea 291): Request.failure
...
-------
Union[str, None]
  - `def timing(self)` (Línea 311): Request.timing
...
{startTime: float, domainLookupStart: float, domainLookupEnd: float, connectStart: float, secureConnectionStart: float, connectEnd: float, requestStart: float, responseStart: float, responseEnd: float}
  - `def headers(self)` (Línea 334): Request.headers
...
-------
Dict[str, str]
  - `def sizes(self)` (Línea 347): Request.sizes
...
{requestBodySize: int, requestHeadersSize: int, responseBodySize: int, responseHeadersSize: int}
  - `def response(self)` (Línea 359): Request.response
...
-------
Union[Response, None]
  - `def is_navigation_request(self)` (Línea 371): Request.is_navigation_request
...
-------
bool
  - `def all_headers(self)` (Línea 386): Request.all_headers
...
-------
Dict[str, str]
  - `def headers_array(self)` (Línea 398): Request.headers_array
...
List[{name: str, value: str}]
  - `def header_value(self, name)` (Línea 412): Request.header_value
...
#### Clase `Response` (Línea 435)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def url(self)` (Línea 438): Response.url
...
-------
str
  - `def ok(self)` (Línea 450): Response.ok
...
-------
bool
  - `def status(self)` (Línea 462): Response.status
...
-------
int
  - `def status_text(self)` (Línea 474): Response.status_text
...
-------
str
  - `def headers(self)` (Línea 486): Response.headers
...
-------
Dict[str, str]
  - `def from_service_worker(self)` (Línea 500): Response.from_service_worker
...
-------
bool
  - `def request(self)` (Línea 513): Response.request
...
-------
Request
  - `def frame(self)` (Línea 525): Response.frame
...
-------
Frame
  - `def all_headers(self)` (Línea 536): Response.all_headers
...
-------
Dict[str, str]
  - `def headers_array(self)` (Línea 548): Response.headers_array
...
-------
List[{name: str, value: str}]
  - `def header_value(self, name)` (Línea 562): Response.header_value
...
-------
Union[str, None]
  - `def header_values(self, name)` (Línea 583): Response.header_values
...
-------
List[str]
  - `def server_addr(self)` (Línea 602): Response.server_addr
...
Union[{ipAddress: str, port: int}, None]
  - `def security_details(self)` (Línea 614): Response.security_details
...
Union[{issuer: Union[str, None], protocol: Union[str, None], subjectName: Union[str, None], validFrom: Union[float, None], validTo: Union[float, None]}, None]
  - `def http_version(self)` (Línea 626): Response.http_version
...
-------
str
  - `def finished(self)` (Línea 638): Response.finished

Waits for this response to finish, returns always `null`.
  - `def body(self)` (Línea 646): Response.body
...
-------
bytes
  - `def text(self)` (Línea 658): Response.text
...
-------
str
  - `def json(self)` (Línea 670): Response.json
...
#### Clase `Route` (Línea 688)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def request(self)` (Línea 691): Route.request
...
-------
Request
  - `def abort(self, error_code)` (Línea 702): Route.abort
...
error_code : Union[str, None]
  ...
  - `def fulfill(self)` (Línea 733): Route.fulfill
...
response : Union[APIResponse, None]
  ...
  - `def fetch(self)` (Línea 799): Route.fetch
...
-------
APIResponse
  - `def fallback(self)` (Línea 873): Route.fallback
...
post_data : Union[Any, bytes, str, None]
  ...
  - `def continue_(self)` (Línea 966): Route.continue_
...
#### Clase `WebSocket` (Línea 1035)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def on(self, event, f)` (Línea 1038): Fired when the websocket closes.
  - `def on(self, event, f)` (Línea 1045): Fired when the websocket receives a frame.
  - `def on(self, event, f)` (Línea 1054): Fired when the websocket sends a frame.
  - `def on(self, event, f)` (Línea 1063): Fired when the websocket has an error.
  - `def on(self, event, f)` (Línea 1069): Sin docstring.
  - `def once(self, event, f)` (Línea 1073): Fired when the websocket closes.
  - `def once(self, event, f)` (Línea 1080): Fired when the websocket receives a frame.
  - `def once(self, event, f)` (Línea 1089): Fired when the websocket sends a frame.
  - `def once(self, event, f)` (Línea 1098): Fired when the websocket has an error.
  - `def once(self, event, f)` (Línea 1104): Sin docstring.
  - `def url(self)` (Línea 1108): WebSocket.url
...
-------
str
  - `def expect_event(self, event, predicate)` (Línea 1120): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 1129): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 1140): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 1151): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 1160): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 1168): WebSocket.expect_event
...
-------
EventContextManager
  - `def wait_for_event(self, event, predicate)` (Línea 1204): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 1213): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 1224): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 1235): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 1244): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 1252): WebSocket.wait_for_event
...
-------
Any
  - `def is_closed(self)` (Línea 1292): WebSocket.is_closed
...
#### Clase `WebSocketRoute` (Línea 1308)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def url(self)` (Línea 1311): WebSocketRoute.url
...
-------
str
  - `def protocols(self)` (Línea 1323): WebSocketRoute.protocols
...
-------
List[str]
  - `def close(self)` (Línea 1350): WebSocketRoute.close
...
reason : Union[str, None]
  ...
  - `def connect_to_server(self)` (Línea 1369): WebSocketRoute.connect_to_server
...
-------
WebSocketRoute
  - `def send(self, message)` (Línea 1392): WebSocketRoute.send
...
message : Union[bytes, str]
    Message to send.
  - `def on_message(self, handler)` (Línea 1407): WebSocketRoute.on_message
...
handler : Callable[[Union[bytes, str]], Any]
  ...
  - `def on_close(self, handler)` (Línea 1433): WebSocketRoute.on_close
...
#### Clase `Keyboard` (Línea 1463)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def down(self, key)` (Línea 1465): Keyboard.down
...
key : str
  ...
  - `def up(self, key)` (Línea 1504): Keyboard.up
...
key : str
    Name of the key to press or a character to generate, such as `ArrowLeft` or `a`.
  - `def insert_text(self, text)` (Línea 1517): Keyboard.insert_text
...
text : str
  ...
  - `def type(self, text)` (Línea 1541): Keyboard.type
...
delay : Union[float, None]
  ...
  - `def press(self, key)` (Línea 1574): Keyboard.press
...
#### Clase `Mouse` (Línea 1631)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def move(self, x, y)` (Línea 1633): Mouse.move
...
steps : Union[int, None]
  ...
  - `def down(self)` (Línea 1653): Mouse.down
...
click_count : Union[int, None]
  ...
  - `def up(self)` (Línea 1675): Mouse.up
...
click_count : Union[int, None]
    defaults to 1. See [UIEvent.detail].
  - `def click(self, x, y)` (Línea 1697): Mouse.click
...
click_count : Union[int, None]
    defaults to 1. See [UIEvent.detail].
  - `def dblclick(self, x, y)` (Línea 1732): Mouse.dblclick
...
button : Union["left", "middle", "right", None]
    Defaults to `left`.
  - `def wheel(self, delta_x, delta_y)` (Línea 1761): Mouse.wheel
...
#### Clase `Touchscreen` (Línea 1786)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def tap(self, x, y)` (Línea 1788): Touchscreen.tap
...
#### Clase `JSHandle` (Línea 1809)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def evaluate(self, expression, arg)` (Línea 1811): JSHandle.evaluate
...
-------
Any
  - `def evaluate_handle(self, expression, arg)` (Línea 1849): JSHandle.evaluate_handle
...
-------
JSHandle
  - `def get_property(self, property_name)` (Línea 1887): JSHandle.get_property
...
-------
JSHandle
  - `def get_properties(self)` (Línea 1906): JSHandle.get_properties
...
-------
Dict[str, JSHandle]
  - `def as_element(self)` (Línea 1928): JSHandle.as_element
...
Union[ElementHandle, None]
  - `def dispose(self)` (Línea 1940): JSHandle.dispose

The `jsHandle.dispose` method stops referencing the element handle.
  - `def json_value(self)` (Línea 1948): JSHandle.json_value
...
#### Clase `ElementHandle` (Línea 1967)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def as_element(self)` (Línea 1969): ElementHandle.as_element
...
-------
Union[ElementHandle, None]
  - `def owner_frame(self)` (Línea 1981): ElementHandle.owner_frame
...
-------
Union[Frame, None]
  - `def content_frame(self)` (Línea 1993): ElementHandle.content_frame
...
-------
Union[Frame, None]
  - `def get_attribute(self, name)` (Línea 2005): ElementHandle.get_attribute
...
-------
Union[str, None]
  - `def text_content(self)` (Línea 2024): ElementHandle.text_content
...
-------
Union[str, None]
  - `def inner_text(self)` (Línea 2036): ElementHandle.inner_text
...
-------
str
  - `def inner_html(self)` (Línea 2048): ElementHandle.inner_html
...
-------
str
  - `def is_checked(self)` (Línea 2060): ElementHandle.is_checked
...
-------
bool
  - `def is_disabled(self)` (Línea 2072): ElementHandle.is_disabled
...
-------
bool
  - `def is_editable(self)` (Línea 2084): ElementHandle.is_editable
...
-------
bool
  - `def is_enabled(self)` (Línea 2096): ElementHandle.is_enabled
...
-------
bool
  - `def is_hidden(self)` (Línea 2108): ElementHandle.is_hidden
...
-------
bool
  - `def is_visible(self)` (Línea 2120): ElementHandle.is_visible
...
-------
bool
  - `def dispatch_event(self, type, event_init)` (Línea 2132): ElementHandle.dispatch_event
...
event_init : Union[Dict, None]
  ...
  - `def scroll_into_view_if_needed(self)` (Línea 2186): ElementHandle.scroll_into_view_if_needed
...
timeout : Union[float, None]
  ...
  - `def hover(self)` (Línea 2217): ElementHandle.hover
...
trial : Union[bool, None]
  ...
  - `def click(self)` (Línea 2276): ElementHandle.click
...
steps : Union[int, None]
    Defaults to 1. Sends `n` interpolated `mousemove` events to represent travel between Playwright's current cursor
    position and the provided destination. When set to 1, emits a single `mousemove` event at the destination location.
  - `def dblclick(self)` (Línea 2355): ElementHandle.dblclick
...
steps : Union[int, None]
    Defaults to 1. Sends `n` interpolated `mousemove` events to represent travel between Playwright's current cursor
    position and the provided destination. When set to 1, emits a single `mousemove` event at the destination location.
  - `def select_option(self, value)` (Línea 2429): ElementHandle.select_option
...
-------
List[str]
  - `def tap(self)` (Línea 2507): ElementHandle.tap
...
trial : Union[bool, None]
    When set, this method only performs the [actionability](../actionability.md) checks and skips the action. Defaults
    to `false`. Useful to wait until the element is ready for the action without performing it.
  - `def fill(self, value)` (Línea 2568): ElementHandle.fill
...
force : Union[bool, None]
    Whether to bypass the [actionability](../actionability.md) checks. Defaults to `false`.
  - `def select_text(self)` (Línea 2613): ElementHandle.select_text
...
timeout : Union[float, None]
    Maximum time in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can
    be changed by using the `browser_context.set_default_timeout()` or `page.set_default_timeout()` methods.
  - `def input_value(self)` (Línea 2645): ElementHandle.input_value
...
-------
str
  - `def set_input_files(self, files)` (Línea 2673): ElementHandle.set_input_files
...
no_wait_after : Union[bool, None]
    This option has no effect.
    Deprecated: This option has no effect.
  - `def focus(self)` (Línea 2718): ElementHandle.focus

Calls [focus](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/focus) on the element.
  - `def type(self, text)` (Línea 2726): ElementHandle.type
...
no_wait_after : Union[bool, None]
    This option has no effect.
    Deprecated: This option has no effect.
  - `def press(self, key)` (Línea 2768): ElementHandle.press
...
no_wait_after : Union[bool, None]
    ...
    navigating to inaccessible pages. Defaults to `false`.
    Deprecated: This option will default to `true` in the future.
  - `def set_checked(self, checked)` (Línea 2827): ElementHandle.set_checked
...
trial : Union[bool, None]
    When set, this method only performs the [actionability](../actionability.md) checks and skips the action. Defaults
    to `false`. Useful to wait until the element is ready for the action without performing it.
  - `def check(self)` (Línea 2884): ElementHandle.check
...
trial : Union[bool, None]
    When set, this method only performs the [actionability](../actionability.md) checks and skips the action. Defaults
    to `false`. Useful to wait until the element is ready for the action without performing it.
  - `def uncheck(self)` (Línea 2938): ElementHandle.uncheck
...
trial : Union[bool, None]
    When set, this method only performs the [actionability](../actionability.md) checks and skips the action. Defaults
    to `false`. Useful to wait until the element is ready for the action without performing it.
  - `def bounding_box(self)` (Línea 2992): ElementHandle.bounding_box
...
Union[{x: float, y: float, width: float, height: float}, None]
  - `def screenshot(self)` (Línea 3022): ElementHandle.screenshot
...
-------
bytes
  - `def query_selector(self, selector)` (Línea 3116): ElementHandle.query_selector
...
-------
Union[ElementHandle, None]
  - `def query_selector_all(self, selector)` (Línea 3136): ElementHandle.query_selector_all
...
-------
List[ElementHandle]
  - `def eval_on_selector(self, selector, expression, arg)` (Línea 3156): ElementHandle.eval_on_selector
...
-------
Any
  - `def eval_on_selector_all(self, selector, expression, arg)` (Línea 3200): ElementHandle.eval_on_selector_all
...
-------
Any
  - `def wait_for_element_state(self, state)` (Línea 3250): ElementHandle.wait_for_element_state
...
timeout : Union[float, None]
    Maximum time in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can
    be changed by using the `browser_context.set_default_timeout()` or `page.set_default_timeout()` methods.
  - `def wait_for_selector(self, selector)` (Línea 3292): ElementHandle.wait_for_selector
...
#### Clase `FileChooser` (Línea 3362)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def page(self)` (Línea 3365): FileChooser.page
...
-------
Page
  - `def element(self)` (Línea 3377): FileChooser.element
...
-------
ElementHandle
  - `def is_multiple(self)` (Línea 3388): FileChooser.is_multiple
...
-------
bool
  - `def set_files(self, files)` (Línea 3400): FileChooser.set_files
...
#### Clase `Frame` (Línea 3443)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def page(self)` (Línea 3446): Frame.page
...
-------
Page
  - `def name(self)` (Línea 3458): Frame.name
...
-------
str
  - `def url(self)` (Línea 3475): Frame.url
...
-------
str
  - `def parent_frame(self)` (Línea 3487): Frame.parent_frame
...
-------
Union[Frame, None]
  - `def child_frames(self)` (Línea 3499): Frame.child_frames

Returns
-------
List[Frame]
  - `def goto(self, url)` (Línea 3508): Frame.goto
...
-------
Union[Response, None]
  - `def expect_navigation(self)` (Línea 3577): Frame.expect_navigation
...
EventContextManager[Response]
  - `def wait_for_url(self, url)` (Línea 3641): Frame.wait_for_url
...
timeout : Union[float, None]
    ...
    `browser_context.set_default_timeout()`, `page.set_default_navigation_timeout()` or
    `page.set_default_timeout()` methods.
  - `def wait_for_load_state(self, state)` (Línea 3692): Frame.wait_for_load_state
...
timeout : Union[float, None]
    ...
    `browser_context.set_default_timeout()`, `page.set_default_navigation_timeout()` or
    `page.set_default_timeout()` methods.
  - `def frame_element(self)` (Línea 3742): Frame.frame_element
...
-------
ElementHandle
  - `def evaluate(self, expression, arg)` (Línea 3767): Frame.evaluate
...
-------
Any
  - `def evaluate_handle(self, expression, arg)` (Línea 3823): Frame.evaluate_handle
...
-------
JSHandle
  - `def query_selector(self, selector)` (Línea 3879): Frame.query_selector
...
-------
Union[ElementHandle, None]
  - `def query_selector_all(self, selector)` (Línea 3908): Frame.query_selector_all
...
-------
List[ElementHandle]
  - `def wait_for_selector(self, selector)` (Línea 3932): Frame.wait_for_selector
...
-------
Union[ElementHandle, None]
  - `def is_checked(self, selector)` (Línea 4010): Frame.is_checked
...
-------
bool
  - `def is_disabled(self, selector)` (Línea 4046): Frame.is_disabled
...
-------
bool
  - `def is_editable(self, selector)` (Línea 4082): Frame.is_editable
...
-------
bool
  - `def is_enabled(self, selector)` (Línea 4118): Frame.is_enabled
...
-------
bool
  - `def is_hidden(self, selector)` (Línea 4154): Frame.is_hidden
...
-------
bool
  - `def is_visible(self, selector)` (Línea 4178): Frame.is_visible
...
-------
bool
  - `def dispatch_event(self, selector, type, event_init)` (Línea 4204): Frame.dispatch_event
...
timeout : Union[float, None]
    Maximum time in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can
    be changed by using the `browser_context.set_default_timeout()` or `page.set_default_timeout()` methods.
  - `def eval_on_selector(self, selector, expression, arg)` (Línea 4277): Frame.eval_on_selector
...
-------
Any
  - `def eval_on_selector_all(self, selector, expression, arg)` (Línea 4332): Frame.eval_on_selector_all
...
-------
Any
  - `def content(self)` (Línea 4374): Frame.content
...
-------
str
  - `def set_content(self, html)` (Línea 4386): Frame.set_content
...
wait_until : Union["commit", "domcontentloaded", "load", "networkidle", None]
    ...
    - `'commit'` - consider operation to be finished when network response is received and the document started
      loading.
  - `def is_detached(self)` (Línea 4427): Frame.is_detached
...
-------
bool
  - `def add_script_tag(self)` (Línea 4439): Frame.add_script_tag
...
-------
ElementHandle
  - `def add_style_tag(self)` (Línea 4479): Frame.add_style_tag
...
-------
ElementHandle
  - `def click(self, selector)` (Línea 4514): Frame.click
...
trial : Union[bool, None]
    ...
    are pressed.
  - `def dblclick(self, selector)` (Línea 4600): Frame.dblclick
...
trial : Union[bool, None]
    ...
    `modifiers` will be pressed regardless of `trial` to allow testing elements which are only visible when those keys
    are pressed.
  - `def tap(self, selector)` (Línea 4682): Frame.tap
...
trial : Union[bool, None]
    ...
    `modifiers` will be pressed regardless of `trial` to allow testing elements which are only visible when those keys
    are pressed.
  - `def fill(self, selector, value)` (Línea 4755): Frame.fill
...
force : Union[bool, None]
    Whether to bypass the [actionability](../actionability.md) checks. Defaults to `false`.
  - `def locator(self, selector)` (Línea 4811): Frame.locator
...
-------
Locator
  - `def get_by_alt_text(self, text)` (Línea 4872): Frame.get_by_alt_text
...
-------
Locator
  - `def get_by_label(self, text)` (Línea 4909): Frame.get_by_label
...
-------
Locator
  - `def get_by_placeholder(self, text)` (Línea 4950): Frame.get_by_placeholder
...
-------
Locator
  - `def get_by_role(self, role)` (Línea 4991): Frame.get_by_role
...
-------
Locator
  - `def get_by_test_id(self, test_id)` (Línea 5199): Frame.get_by_test_id
...
-------
Locator
  - `def get_by_text(self, text)` (Línea 5237): Frame.get_by_text
...
-------
Locator
  - `def get_by_title(self, text)` (Línea 5301): Frame.get_by_title
...
-------
Locator
  - `def frame_locator(self, selector)` (Línea 5340): Frame.frame_locator
...
-------
FrameLocator
  - `def focus(self, selector)` (Línea 5368): Frame.focus
...
timeout : Union[float, None]
    Maximum time in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can
    be changed by using the `browser_context.set_default_timeout()` or `page.set_default_timeout()` methods.
  - `def text_content(self, selector)` (Línea 5401): Frame.text_content
...
-------
Union[str, None]
  - `def inner_text(self, selector)` (Línea 5437): Frame.inner_text
...
-------
str
  - `def inner_html(self, selector)` (Línea 5473): Frame.inner_html
...
-------
str
  - `def get_attribute(self, selector, name)` (Línea 5509): Frame.get_attribute
...
-------
Union[str, None]
  - `def hover(self, selector)` (Línea 5551): Frame.hover
...
trial : Union[bool, None]
    ...
    `modifiers` will be pressed regardless of `trial` to allow testing elements which are only visible when those keys
    are pressed.
  - `def drag_and_drop(self, source, target)` (Línea 5622): Frame.drag_and_drop
...
steps : Union[int, None]
  ...
  - `def select_option(self, selector, value)` (Línea 5688): Frame.select_option
...
-------
List[str]
  - `def input_value(self, selector)` (Línea 5775): Frame.input_value
...
-------
str
  - `def set_input_files(self, selector, files)` (Línea 5815): Frame.set_input_files
...
no_wait_after : Union[bool, None]
    This option has no effect.
    Deprecated: This option has no effect.
  - `def type(self, selector, text)` (Línea 5869): Frame.type
...
no_wait_after : Union[bool, None]
    This option has no effect.
    Deprecated: This option has no effect.
  - `def press(self, selector, key)` (Línea 5921): Frame.press
...
no_wait_after : Union[bool, None]
    ...
    navigating to inaccessible pages. Defaults to `false`.
    Deprecated: This option will default to `true` in the future.
  - `def check(self, selector)` (Línea 5988): Frame.check
...
trial : Union[bool, None]
    When set, this method only performs the [actionability](../actionability.md) checks and skips the action. Defaults
    to `false`. Useful to wait until the element is ready for the action without performing it.
  - `def uncheck(self, selector)` (Línea 6052): Frame.uncheck
...
trial : Union[bool, None]
    When set, this method only performs the [actionability](../actionability.md) checks and skips the action. Defaults
    to `false`. Useful to wait until the element is ready for the action without performing it.
  - `def wait_for_timeout(self, timeout)` (Línea 6116): Frame.wait_for_timeout
...
timeout : float
  ...
  - `def wait_for_function(self, expression)` (Línea 6138): Frame.wait_for_function
...
-------
JSHandle
  - `def title(self)` (Línea 6208): Frame.title
...
-------
str
  - `def set_checked(self, selector, checked)` (Línea 6220): Frame.set_checked
...
#### Clase `FrameLocator` (Línea 6292)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def first(self)` (Línea 6295): FrameLocator.first
...
-------
FrameLocator
  - `def last(self)` (Línea 6307): FrameLocator.last
...
-------
FrameLocator
  - `def owner(self)` (Línea 6319): FrameLocator.owner
...
-------
Locator
  - `def locator(self, selector_or_locator)` (Línea 6344): FrameLocator.locator
...
-------
Locator
  - `def get_by_alt_text(self, text)` (Línea 6402): FrameLocator.get_by_alt_text
...
-------
Locator
  - `def get_by_label(self, text)` (Línea 6439): FrameLocator.get_by_label
...
-------
Locator
  - `def get_by_placeholder(self, text)` (Línea 6480): FrameLocator.get_by_placeholder
...
-------
Locator
  - `def get_by_role(self, role)` (Línea 6521): FrameLocator.get_by_role
...
-------
Locator
  - `def get_by_test_id(self, test_id)` (Línea 6729): FrameLocator.get_by_test_id
...
-------
Locator
  - `def get_by_text(self, text)` (Línea 6767): FrameLocator.get_by_text
...
-------
Locator
  - `def get_by_title(self, text)` (Línea 6831): FrameLocator.get_by_title
...
-------
Locator
  - `def frame_locator(self, selector)` (Línea 6870): FrameLocator.frame_locator
...
-------
FrameLocator
  - `def nth(self, index)` (Línea 6888): FrameLocator.nth
...
#### Clase `Worker` (Línea 6908)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def on(self, event, f)` (Línea 6911): Emitted when this dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is
terminated.
  - `def on(self, event, f)` (Línea 6919): Emitted when JavaScript within the worker calls one of console API methods, e.g. `console.log` or `console.dir`.
  - `def on(self, event, f)` (Línea 6926): Sin docstring.
  - `def once(self, event, f)` (Línea 6930): Emitted when this dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is
terminated.
  - `def once(self, event, f)` (Línea 6938): Emitted when JavaScript within the worker calls one of console API methods, e.g. `console.log` or `console.dir`.
  - `def once(self, event, f)` (Línea 6945): Sin docstring.
  - `def url(self)` (Línea 6949): Worker.url

Returns
-------
str
  - `def evaluate(self, expression, arg)` (Línea 6958): Worker.evaluate
...
-------
Any
  - `def evaluate_handle(self, expression, arg)` (Línea 6991): Worker.evaluate_handle
...
-------
JSHandle
  - `def expect_event(self, event, predicate)` (Línea 7026): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 7035): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 7044): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 7052): Worker.expect_event
...
#### Clase `Selectors` (Línea 7099)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def register(self, name, script)` (Línea 7101): Selectors.register
...
content_script : Union[bool, None]
  ...
  - `def set_test_id_attribute(self, attribute_name)` (Línea 7176): Selectors.set_test_id_attribute
...
#### Clase `Clock` (Línea 7195)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def install(self)` (Línea 7197): Clock.install
...
time : Union[datetime.datetime, float, str, None]
  ...
  - `def fast_forward(self, ticks)` (Línea 7228): Clock.fast_forward
...
ticks : Union[int, str]
  ...
  - `def pause_at(self, time)` (Línea 7252): Clock.pause_at
...
time : Union[datetime.datetime, float, str]
    Time to pause at.
  - `def resume(self)` (Línea 7289): Clock.resume

Resumes timers. Once this method is called, time resumes flowing, timers are fired as usual.
  - `def run_for(self, ticks)` (Línea 7297): Clock.run_for
...
ticks : Union[int, str]
    Time may be the number of milliseconds to advance the clock by or a human-readable string. Valid string formats are
    "08" for eight seconds, "01:00" for one minute and "02:34:10" for two hours, 34 minutes and ten seconds.
  - `def set_fixed_time(self, time)` (Línea 7318): Clock.set_fixed_time
...
time : Union[datetime.datetime, float, str]
    Time to be set.
  - `def set_system_time(self, time)` (Línea 7344): Clock.set_system_time
...
#### Clase `ConsoleMessage` (Línea 7374)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def type(self)` (Línea 7377): ConsoleMessage.type
...
Union["assert", "clear", "count", "debug", "dir", "dirxml", "endGroup", "error", "info", "log", "profile", "profileEnd", "startGroup", "startGroupCollapsed", "table", "time", "timeEnd", "trace", "warning"]
  - `def text(self)` (Línea 7409): ConsoleMessage.text
...
-------
str
  - `def args(self)` (Línea 7421): ConsoleMessage.args
...
-------
List[JSHandle]
  - `def location(self)` (Línea 7433): ConsoleMessage.location

Returns
-------
{url: str, line: int, column: int, lineNumber: int, columnNumber: int}
  - `def timestamp(self)` (Línea 7443): ConsoleMessage.timestamp
...
-------
float
  - `def page(self)` (Línea 7455): ConsoleMessage.page
...
-------
Union[Page, None]
  - `def worker(self)` (Línea 7467): ConsoleMessage.worker
...
#### Clase `Debugger` (Línea 7483)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def on(self, event, f)` (Línea 7486): Emitted when the debugger pauses or resumes.
  - `def on(self, event, f)` (Línea 7493): Sin docstring.
  - `def on(self, event, f)` (Línea 7495): Sin docstring.
  - `def once(self, event, f)` (Línea 7499): Emitted when the debugger pauses or resumes.
  - `def once(self, event, f)` (Línea 7506): Sin docstring.
  - `def once(self, event, f)` (Línea 7508): Sin docstring.
  - `def paused_details(self)` (Línea 7512): Debugger.paused_details
...
Union[{location: {file: str, line: Union[int, None], column: Union[int, None]}, title: str}, None]
  - `def request_pause(self)` (Línea 7523): Debugger.request_pause
...
#### Clase `Dialog` (Línea 7574)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def type(self)` (Línea 7577): Dialog.type
...
-------
str
  - `def message(self)` (Línea 7589): Dialog.message
...
-------
str
  - `def default_value(self)` (Línea 7601): Dialog.default_value
...
-------
str
  - `def page(self)` (Línea 7613): Dialog.page
...
-------
Union[Page, None]
  - `def accept(self, prompt_text)` (Línea 7624): Dialog.accept
...
prompt_text : Union[str, None]
  ...
  - `def dismiss(self)` (Línea 7639): Dialog.dismiss

Returns when the dialog has been dismissed.

#### Clase `Download` (Línea 7651)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def page(self)` (Línea 7654): Download.page
...
-------
Page
  - `def url(self)` (Línea 7666): Download.url
...
-------
str
  - `def suggested_filename(self)` (Línea 7678): Download.suggested_filename
...
-------
str
  - `def delete(self)` (Línea 7692): Download.delete

Deletes the downloaded file. Will wait for the download to finish if necessary.
  - `def failure(self)` (Línea 7700): Download.failure
...
-------
Union[str, None]
  - `def path(self)` (Línea 7712): Download.path
...
-------
pathlib.Path
  - `def save_as(self, path)` (Línea 7728): Download.save_as
...
path : Union[pathlib.Path, str]
  ...
  - `def cancel(self)` (Línea 7748): Download.cancel

Cancels a download. Will not fail if the download is already finished or canceled. Upon successful cancellations,
`download.failure()` would resolve to `'canceled'`.

#### Clase `Screencast` (Línea 7761)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def start(self)` (Línea 7763): Screencast.start
...
-------
SyncContextManager
  - `def hide_actions(self)` (Línea 7847): Screencast.hide_actions

Removes action decorations.
  - `def show_overlay(self, html)` (Línea 7855): Screencast.show_overlay
...
-------
SyncContextManager
  - `def show_chapter(self, title)` (Línea 7880): Screencast.show_chapter
...
duration : Union[float, None]
  ...
  - `def show_overlays(self)` (Línea 7910): Screencast.show_overlays

Shows overlays.
  - `def hide_overlays(self)` (Línea 7918): Screencast.hide_overlays

Hides overlays without removing them.

#### Clase `Video` (Línea 7930)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def path(self)` (Línea 7932): Video.path
...
-------
pathlib.Path
  - `def save_as(self, path)` (Línea 7945): Video.save_as
...
path : Union[pathlib.Path, str]
  ...
  - `def delete(self)` (Línea 7959): Video.delete

Deletes the video file. Will wait for the video to finish if necessary.

#### Clase `Page` (Línea 7971)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def on(self, event, f)` (Línea 7974): Emitted when the page closes.
  - `def on(self, event, f)` (Línea 7979): Emitted when JavaScript within the page calls one of console API methods, e.g. `console.log` or `console.dir`.
...
```
  - `def on(self, event, f)` (Línea 7999): Emitted when the page crashes. Browser pages might crash if they try to allocate too much memory. When the page
...
```
  - `def on(self, event, f)` (Línea 8018): Emitted when a JavaScript dialog appears, such as `alert`, `prompt`, `confirm` or `beforeunload`. Listener **must**
...
automatically dismissed.
  - `def on(self, event, f)` (Línea 8037): Emitted when the JavaScript
[`DOMContentLoaded`](https://developer.mozilla.org/en-US/docs/Web/Events/DOMContentLoaded) event is dispatched.
  - `def on(self, event, f)` (Línea 8046): Emitted when attachment download started. User can access basic file operations on downloaded content via the
passed `Download` instance.
  - `def on(self, event, f)` (Línea 8054): Emitted when a file chooser is supposed to appear, such as after clicking the  `<input type=file>`. Playwright can
respond to it via setting the input files using `file_chooser.set_files()` that can be uploaded after that.

```py
page.on("filechooser", lambda file_chooser: file_chooser.set_files("/tmp/myfile.pdf"))
```
  - `def on(self, event, f)` (Línea 8066): Emitted when a frame is attached.
  - `def on(self, event, f)` (Línea 8073): Emitted when a frame is detached.
  - `def on(self, event, f)` (Línea 8080): Emitted when a frame is navigated to a new url.
  - `def on(self, event, f)` (Línea 8087): Emitted when the JavaScript [`load`](https://developer.mozilla.org/en-US/docs/Web/Events/load) event is dispatched.
  - `def on(self, event, f)` (Línea 8093): Emitted when an uncaught exception happens within the page.
...
```
  - `def on(self, event, f)` (Línea 8108): Emitted when the page opens a new tab or window. This event is emitted in addition to the
...
need it in most cases).
  - `def on(self, event, f)` (Línea 8130): Emitted when a page issues a request. The [request] object is read-only. In order to intercept and mutate requests,
see `page.route()` or `browser_context.route()`.
  - `def on(self, event, f)` (Línea 8138): Emitted when a request fails, for example by timing out.
...
net::ERR_FAILED.
  - `def on(self, event, f)` (Línea 8154): Emitted when a request finishes successfully after downloading the response body. For a successful response, the
sequence of events is `request`, `response` and `requestfinished`.
  - `def on(self, event, f)` (Línea 8162): Emitted when [response] status and headers are received for a request. For a successful response, the sequence of
events is `request`, `response` and `requestfinished`.
  - `def on(self, event, f)` (Línea 8170): Emitted when `WebSocket` request is sent.
  - `def on(self, event, f)` (Línea 8177): Emitted when a dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is spawned
by the page.
  - `def on(self, event, f)` (Línea 8184): Sin docstring.
  - `def once(self, event, f)` (Línea 8188): Emitted when the page closes.
  - `def once(self, event, f)` (Línea 8195): Emitted when JavaScript within the page calls one of console API methods, e.g. `console.log` or `console.dir`.
...
page.evaluate("console.log('hello', 5, { foo: 'bar' })")
```
  - `def once(self, event, f)` (Línea 8215): Emitted when the page crashes. Browser pages might crash if they try to allocate too much memory. When the page
crashes, ongoing and subsequent operations will throw.
...
try:
    ...
    # when the page crashes, exception message contains "crash".
```
  - `def once(self, event, f)` (Línea 8236): Emitted when a JavaScript dialog appears, such as `alert`, `prompt`, `confirm` or `beforeunload`. Listener **must**
either `dialog.accept()` or `dialog.dismiss()` the dialog - otherwise the page will
[freeze](https://developer.mozilla.org/en-US/docs/Web/JavaScript/EventLoop#never_blocking) waiting for the dialog,
and actions like click will never finish.
...
**NOTE** When no `page.on('dialog')` or `browser_context.on('dialog')` listeners are present, all dialogs are
automatically dismissed.
  - `def once(self, event, f)` (Línea 8255): Emitted when the JavaScript
[`DOMContentLoaded`](https://developer.mozilla.org/en-US/docs/Web/Events/DOMContentLoaded) event is dispatched.
  - `def once(self, event, f)` (Línea 8264): Emitted when attachment download started. User can access basic file operations on downloaded content via the
passed `Download` instance.
  - `def once(self, event, f)` (Línea 8272): Emitted when a file chooser is supposed to appear, such as after clicking the  `<input type=file>`. Playwright can
respond to it via setting the input files using `file_chooser.set_files()` that can be uploaded after that.

```py
page.on("filechooser", lambda file_chooser: file_chooser.set_files("/tmp/myfile.pdf"))
```
  - `def once(self, event, f)` (Línea 8284): Emitted when a frame is attached.
  - `def once(self, event, f)` (Línea 8291): Emitted when a frame is detached.
  - `def once(self, event, f)` (Línea 8298): Emitted when a frame is navigated to a new url.
  - `def once(self, event, f)` (Línea 8305): Emitted when the JavaScript [`load`](https://developer.mozilla.org/en-US/docs/Web/Events/load) event is dispatched.
  - `def once(self, event, f)` (Línea 8313): Emitted when an uncaught exception happens within the page.
...
page.goto("data:text/html,<script>throw new Error('test')</script>")
```
  - `def once(self, event, f)` (Línea 8328): Emitted when the page opens a new tab or window. This event is emitted in addition to the
`browser_context.on('page')`, but only for popups relevant to this page.
...
**NOTE** Use `page.wait_for_load_state()` to wait until the page gets to a particular state (you should not
need it in most cases).
  - `def once(self, event, f)` (Línea 8352): Emitted when a page issues a request. The [request] object is read-only. In order to intercept and mutate requests,
see `page.route()` or `browser_context.route()`.
  - `def once(self, event, f)` (Línea 8360): Emitted when a request fails, for example by timing out.
...
only be considered failed when the client cannot get an HTTP response from the server, e.g. due to network error
net::ERR_FAILED.
  - `def once(self, event, f)` (Línea 8376): Emitted when a request finishes successfully after downloading the response body. For a successful response, the
sequence of events is `request`, `response` and `requestfinished`.
  - `def once(self, event, f)` (Línea 8384): Emitted when [response] status and headers are received for a request. For a successful response, the sequence of
events is `request`, `response` and `requestfinished`.
  - `def once(self, event, f)` (Línea 8392): Emitted when `WebSocket` request is sent.
  - `def once(self, event, f)` (Línea 8399): Emitted when a dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is spawned
by the page.
  - `def once(self, event, f)` (Línea 8406): Sin docstring.
  - `def keyboard(self)` (Línea 8410): Page.keyboard

Returns
-------
Keyboard
  - `def mouse(self)` (Línea 8420): Page.mouse

Returns
-------
Mouse
  - `def touchscreen(self)` (Línea 8430): Page.touchscreen

Returns
-------
Touchscreen
  - `def context(self)` (Línea 8440): Page.context
...
-------
BrowserContext
  - `def clock(self)` (Línea 8452): Page.clock
...
-------
Clock
  - `def main_frame(self)` (Línea 8464): Page.main_frame
...
-------
Frame
  - `def frames(self)` (Línea 8476): Page.frames
...
-------
List[Frame]
  - `def url(self)` (Línea 8488): Page.url

Returns
-------
str
  - `def viewport_size(self)` (Línea 8498): Page.viewport_size

Returns
-------
Union[{width: int, height: int}, None]
  - `def workers(self)` (Línea 8508): Page.workers
...
-------
List[Worker]
  - `def request(self)` (Línea 8523): Page.request
...
-------
APIRequestContext
  - `def video(self)` (Línea 8537): Page.video
...
-------
Union[Video, None]
  - `def screencast(self)` (Línea 8550): Page.screencast
...
-------
Screencast
  - `def opener(self)` (Línea 8563): Page.opener
...
-------
Union[Page, None]
  - `def frame(self, name)` (Línea 8575): Page.frame
...
-------
Union[Frame, None]
  - `def set_default_navigation_timeout(self, timeout)` (Línea 8609): Page.set_default_navigation_timeout
...
timeout : float
  ...
  - `def set_default_timeout(self, timeout)` (Línea 8638): Page.set_default_timeout
...
timeout : float
  ...
  - `def query_selector(self, selector)` (Línea 8657): Page.query_selector
...
-------
Union[ElementHandle, None]
  - `def query_selector_all(self, selector)` (Línea 8682): Page.query_selector_all
...
-------
List[ElementHandle]
  - `def wait_for_selector(self, selector)` (Línea 8702): Page.wait_for_selector
...
-------
Union[ElementHandle, None]
  - `def is_checked(self, selector)` (Línea 8780): Page.is_checked
...
-------
bool
  - `def is_disabled(self, selector)` (Línea 8816): Page.is_disabled
...
-------
bool
  - `def is_editable(self, selector)` (Línea 8852): Page.is_editable
...
-------
bool
  - `def is_enabled(self, selector)` (Línea 8888): Page.is_enabled
...
-------
bool
  - `def is_hidden(self, selector)` (Línea 8924): Page.is_hidden
...
-------
bool
  - `def is_visible(self, selector)` (Línea 8960): Page.is_visible
...
-------
bool
  - `def dispatch_event(self, selector, type, event_init)` (Línea 8996): Page.dispatch_event
...
strict : Union[bool, None]
    When true, the call requires selector to resolve to a single element. If given selector resolves to more than one
    element, the call throws an exception.
  - `def evaluate(self, expression, arg)` (Línea 9069): Page.evaluate
...
-------
Any
  - `def evaluate_handle(self, expression, arg)` (Línea 9127): Page.evaluate_handle
...
-------
JSHandle
  - `def eval_on_selector(self, selector, expression, arg)` (Línea 9183): Page.eval_on_selector
...
-------
Any
  - `def eval_on_selector_all(self, selector, expression, arg)` (Línea 9236): Page.eval_on_selector_all
...
-------
Any
  - `def add_script_tag(self)` (Línea 9276): Page.add_script_tag
...
-------
ElementHandle
  - `def add_style_tag(self)` (Línea 9315): Page.add_style_tag
...
-------
ElementHandle
  - `def expose_function(self, name, callback)` (Línea 9348): Page.expose_function
...
-------
SyncContextManager
  - `def expose_binding(self, name, callback)` (Línea 9415): Page.expose_binding
...
-------
SyncContextManager
  - `def set_extra_http_headers(self, headers)` (Línea 9479): Page.set_extra_http_headers
...
headers : Dict[str, str]
  ...
  - `def content(self)` (Línea 9498): Page.content
...
-------
str
  - `def set_content(self, html)` (Línea 9510): Page.set_content
...
wait_until : Union["commit", "domcontentloaded", "load", "networkidle", None]
    ...
    - `'commit'` - consider operation to be finished when network response is received and the document started
      loading.
  - `def goto(self, url)` (Línea 9551): Page.goto
...
-------
Union[Response, None]
  - `def reload(self)` (Línea 9622): Page.reload
...
-------
Union[Response, None]
  - `def wait_for_load_state(self, state)` (Línea 9665): Page.wait_for_load_state
...
timeout : Union[float, None]
    ...
    `browser_context.set_default_timeout()`, `page.set_default_navigation_timeout()` or
    `page.set_default_timeout()` methods.
  - `def wait_for_url(self, url)` (Línea 9724): Page.wait_for_url
...
timeout : Union[float, None]
    ...
    `browser_context.set_default_timeout()`, `page.set_default_navigation_timeout()` or
    `page.set_default_timeout()` methods.
  - `def wait_for_event(self, event, predicate)` (Línea 9776): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9785): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9794): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9803): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9812): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9821): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9830): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9839): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9848): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9857): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9866): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9875): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9884): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9893): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9902): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9911): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9920): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9929): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9938): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9947): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 9955): Page.wait_for_event
...
-------
Any
  - `def go_back(self)` (Línea 9995): Page.go_back
...
-------
Union[Response, None]
  - `def go_forward(self)` (Línea 10039): Page.go_forward
...
-------
Union[Response, None]
  - `def request_gc(self)` (Línea 10083): Page.request_gc
...
```
  - `def emulate_media(self)` (Línea 10105): Page.emulate_media
...
contrast : Union["more", "no-preference", "null", None]
  - `def set_viewport_size(self, viewport_size)` (Línea 10180): Page.set_viewport_size
...
viewport_size : {width: int, height: int}
  - `def bring_to_front(self)` (Línea 10208): Page.bring_to_front

Brings page to front (activates tab).
  - `def hide_highlight(self)` (Línea 10216): Page.hide_highlight

Hide all locator highlight overlays previously added by `locator.highlight()` on this page.
  - `def add_init_script(self, script)` (Línea 10224): Page.add_init_script
...
-------
SyncContextManager
  - `def route(self, url, handler)` (Línea 10269): Page.route
...
-------
SyncContextManager
  - `def unroute(self, url, handler)` (Línea 10362): Page.unroute
...
handler : Union[Callable[[Route, Request], Any], Callable[[Route], Any], None]
  ...
  - `def route_web_socket(self, url, handler)` (Línea 10393): Page.route_web_socket
...
handler : Callable[[WebSocketRoute], Any]
  ...
  - `def unroute_all(self)` (Línea 10438): Page.unroute_all
...
behavior : Union["default", "ignoreErrors", "wait", None]
  ...
  - `def route_from_har(self, har)` (Línea 10462): Page.route_from_har
...
update_mode : Union["full", "minimal", None]
    ...
    `minimal`.
  - `def screenshot(self)` (Línea 10519): Page.screenshot
...
-------
bytes
  - `def title(self)` (Línea 10615): Page.title
...
-------
str
  - `def aria_snapshot(self)` (Línea 10627): Page.aria_snapshot
...
-------
str
  - `def close(self)` (Línea 10671): Page.close
...
reason : Union[str, None]
  ...
  - `def is_closed(self)` (Línea 10702): Page.is_closed
...
-------
bool
  - `def click(self, selector)` (Línea 10714): Page.click
...
strict : Union[bool, None]
    When true, the call requires selector to resolve to a single element. If given selector resolves to more than one
    element, the call throws an exception.
  - `def dblclick(self, selector)` (Línea 10800): Page.dblclick
...
trial : Union[bool, None]
    ...
    `modifiers` will be pressed regardless of `trial` to allow testing elements which are only visible when those keys
    are pressed.
  - `def tap(self, selector)` (Línea 10881): Page.tap
...
trial : Union[bool, None]
    ...
    `modifiers` will be pressed regardless of `trial` to allow testing elements which are only visible when those keys
    are pressed.
  - `def fill(self, selector, value)` (Línea 10954): Page.fill
...
force : Union[bool, None]
    Whether to bypass the [actionability](../actionability.md) checks. Defaults to `false`.
  - `def locator(self, selector)` (Línea 11010): Page.locator
...
-------
Locator
  - `def get_by_alt_text(self, text)` (Línea 11069): Page.get_by_alt_text
...
-------
Locator
  - `def get_by_label(self, text)` (Línea 11106): Page.get_by_label
...
-------
Locator
  - `def get_by_placeholder(self, text)` (Línea 11147): Page.get_by_placeholder
...
-------
Locator
  - `def get_by_role(self, role)` (Línea 11188): Page.get_by_role
...
-------
Locator
  - `def get_by_test_id(self, test_id)` (Línea 11396): Page.get_by_test_id
...
-------
Locator
  - `def get_by_text(self, text)` (Línea 11434): Page.get_by_text
...
-------
Locator
  - `def get_by_title(self, text)` (Línea 11498): Page.get_by_title
...
-------
Locator
  - `def frame_locator(self, selector)` (Línea 11537): Page.frame_locator
...
-------
FrameLocator
  - `def focus(self, selector)` (Línea 11565): Page.focus
...
timeout : Union[float, None]
    Maximum time in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can
    be changed by using the `browser_context.set_default_timeout()` or `page.set_default_timeout()` methods.
  - `def text_content(self, selector)` (Línea 11598): Page.text_content
...
-------
Union[str, None]
  - `def inner_text(self, selector)` (Línea 11634): Page.inner_text
...
-------
str
  - `def inner_html(self, selector)` (Línea 11670): Page.inner_html
...
-------
str
  - `def get_attribute(self, selector, name)` (Línea 11706): Page.get_attribute
...
-------
Union[str, None]
  - `def hover(self, selector)` (Línea 11748): Page.hover
...
trial : Union[bool, None]
    ...
    `modifiers` will be pressed regardless of `trial` to allow testing elements which are only visible when those keys
    are pressed.
  - `def drag_and_drop(self, source, target)` (Línea 11819): Page.drag_and_drop
...
steps : Union[int, None]
    Defaults to 1. Sends `n` interpolated `mousemove` events to represent travel between the `mousedown` and `mouseup`
    of the drag. When set to 1, emits a single `mousemove` event at the destination location.
  - `def select_option(self, selector, value)` (Línea 11901): Page.select_option
...
-------
List[str]
  - `def input_value(self, selector)` (Línea 11989): Page.input_value
...
-------
str
  - `def set_input_files(self, selector, files)` (Línea 12029): Page.set_input_files
...
no_wait_after : Union[bool, None]
    This option has no effect.
    Deprecated: This option has no effect.
  - `def type(self, selector, text)` (Línea 12084): Page.type
...
strict : Union[bool, None]
    When true, the call requires selector to resolve to a single element. If given selector resolves to more than one
    element, the call throws an exception.
  - `def press(self, selector, key)` (Línea 12136): Page.press
...
strict : Union[bool, None]
    When true, the call requires selector to resolve to a single element. If given selector resolves to more than one
    element, the call throws an exception.
  - `def check(self, selector)` (Línea 12219): Page.check
...
trial : Union[bool, None]
    When set, this method only performs the [actionability](../actionability.md) checks and skips the action. Defaults
    to `false`. Useful to wait until the element is ready for the action without performing it.
  - `def uncheck(self, selector)` (Línea 12283): Page.uncheck
...
trial : Union[bool, None]
    When set, this method only performs the [actionability](../actionability.md) checks and skips the action. Defaults
    to `false`. Useful to wait until the element is ready for the action without performing it.
  - `def wait_for_timeout(self, timeout)` (Línea 12347): Page.wait_for_timeout
...
timeout : float
    A timeout to wait for
  - `def wait_for_function(self, expression)` (Línea 12376): Page.wait_for_function
...
-------
JSHandle
  - `def pause(self)` (Línea 12446): Page.pause
...
**NOTE** This method requires Playwright to be started in a headed mode, with a falsy `headless` option.
  - `def pdf(self)` (Línea 12460): Page.pdf
...
-------
bytes
  - `def expect_event(self, event, predicate)` (Línea 12597): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12606): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12615): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12624): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12633): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12642): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12651): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12660): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12669): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12678): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12687): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12696): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12705): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12714): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12723): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12732): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12741): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12750): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12759): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12768): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 12776): Page.expect_event
...
-------
EventContextManager
  - `def expect_console_message(self, predicate)` (Línea 12819): Page.expect_console_message
...
EventContextManager[ConsoleMessage]
  - `def expect_download(self, predicate)` (Línea 12851): Page.expect_download
...
EventContextManager[Download]
  - `def expect_file_chooser(self, predicate)` (Línea 12883): Page.expect_file_chooser
...
EventContextManager[FileChooser]
  - `def expect_navigation(self)` (Línea 12915): Page.expect_navigation
...
-------
EventContextManager[Response]
  - `def expect_popup(self, predicate)` (Línea 12981): Page.expect_popup
...
EventContextManager[Page]
  - `def expect_request(self, url_or_predicate)` (Línea 13013): Page.expect_request
...
EventContextManager[Request]
  - `def expect_request_finished(self, predicate)` (Línea 13061): Page.expect_request_finished
...
-------
EventContextManager[Request]
  - `def expect_response(self, url_or_predicate)` (Línea 13093): Page.expect_response
...
-------
EventContextManager[Response]
  - `def expect_websocket(self, predicate)` (Línea 13143): Page.expect_websocket
...
EventContextManager[WebSocket]
  - `def expect_worker(self, predicate)` (Línea 13175): Page.expect_worker
...
EventContextManager[Worker]
  - `def set_checked(self, selector, checked)` (Línea 13207): Page.set_checked
...
trial : Union[bool, None]
    When set, this method only performs the [actionability](../actionability.md) checks and skips the action. Defaults
    to `false`. Useful to wait until the element is ready for the action without performing it.
  - `def add_locator_handler(self, locator, handler)` (Línea 13275): Page.add_locator_handler
...
times : Union[int, None]
  ...
  - `def remove_locator_handler(self, locator)` (Línea 13400): Page.remove_locator_handler
...
locator : Locator
  ...
  - `def requests(self)` (Línea 13415): Page.requests
...
-------
List[Request]
  - `def console_messages(self)` (Línea 13434): Page.console_messages
...
-------
List[ConsoleMessage]
  - `def page_errors(self)` (Línea 13455): Page.page_errors
...
-------
List[Error]
  - `def clear_console_messages(self)` (Línea 13476): Page.clear_console_messages
...
return messages logged after the clear.
  - `def clear_page_errors(self)` (Línea 13487): Page.clear_page_errors
...
errors thrown after the clear.
  - `def pick_locator(self)` (Línea 13496): Page.pick_locator
...
-------
Locator
  - `def cancel_pick_locator(self)` (Línea 13516): Page.cancel_pick_locator
...
#### Clase `WebError` (Línea 13529)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def page(self)` (Línea 13532): WebError.page
...
-------
Union[Page, None]
  - `def error(self)` (Línea 13544): WebError.error
...
-------
Error
  - `def location(self)` (Línea 13556): WebError.location

Returns
-------
{url: str, line: int, column: int}

#### Clase `BrowserContext` (Línea 13569)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def on(self, event, f)` (Línea 13572): This event is not emitted.
  - `def on(self, event, f)` (Línea 13579): Emitted when Browser context gets closed. This might happen because of one of the following:
- Browser context is closed.
- Browser application is closed or crashed.
- The `browser.close()` method was called.
  - `def on(self, event, f)` (Línea 13589): Emitted when JavaScript within the page calls one of console API methods, e.g. `console.log` or `console.dir`.
...
page.evaluate("console.log('hello', 5, { foo: 'bar' })")
```
  - `def on(self, event, f)` (Línea 13609): Emitted when a JavaScript dialog appears, such as `alert`, `prompt`, `confirm` or `beforeunload`. Listener **must**
either `dialog.accept()` or `dialog.dismiss()` the dialog - otherwise the page will
[freeze](https://developer.mozilla.org/en-US/docs/Web/JavaScript/EventLoop#never_blocking) waiting for the dialog,
and actions like click will never finish.
...
**NOTE** When no `page.on('dialog')` or `browser_context.on('dialog')` listeners are present, all dialogs are
automatically dismissed.
  - `def on(self, event, f)` (Línea 13628): Emitted when attachment download started in any page belonging to this context. User can access basic file
...
events about a specific page.
  - `def on(self, event, f)` (Línea 13637): Emitted when a frame is attached in any page belonging to this context. See also `page.on('frame_attached')` to
receive events about a specific page.
  - `def on(self, event, f)` (Línea 13645): Emitted when a frame is detached in any page belonging to this context. See also `page.on('frame_detached')` to
receive events about a specific page.
  - `def on(self, event, f)` (Línea 13653): Emitted when a frame is navigated to a new url in any page belonging to this context. See also
`page.on('frame_navigated')` to receive events about navigations in a specific page.
  - `def on(self, event, f)` (Línea 13662): The event is emitted when a new Page is created in the BrowserContext. The page may still be loading. The event
...
**NOTE** Use `page.wait_for_load_state()` to wait until the page gets to a particular state (you should not
need it in most cases).
  - `def on(self, event, f)` (Línea 13685): Emitted when a page in this context is closed. See also `page.on('close')` to receive events about a specific
page.
  - `def on(self, event, f)` (Línea 13693): Emitted when the JavaScript [`load`](https://developer.mozilla.org/en-US/docs/Web/Events/load) event is dispatched
in any page belonging to this context. See also `page.on('load')` to receive events about a specific page.
  - `def on(self, event, f)` (Línea 13702): Emitted when exception is unhandled in any of the pages in this context. To listen for errors from a particular
page, use `page.on('page_error')` instead.
  - `def on(self, event, f)` (Línea 13710): Emitted when a request is issued from any pages created through this context. The [request] object is read-only. To
...
In order to intercept and mutate requests, see `browser_context.route()` or `page.route()`.
  - `def on(self, event, f)` (Línea 13721): Emitted when a request fails, for example by timing out. To only listen for failed requests from a particular page,
...
`browser_context.on('request_failed')`.
  - `def on(self, event, f)` (Línea 13733): Emitted when a request finishes successfully after downloading the response body. For a successful response, the
...
particular page, use `page.on('request_finished')`.
  - `def on(self, event, f)` (Línea 13742): Emitted when [response] status and headers are received for a request. For a successful response, the sequence of
events is `request`, `response` and `requestfinished`. To listen for response events from a particular page, use
`page.on('response')`.
  - `def on(self, event, f)` (Línea 13751): **NOTE** Service workers are only supported on Chromium-based browsers.

Emitted when new service worker is created in the context.
  - `def on(self, event, f)` (Línea 13759): Sin docstring.
  - `def once(self, event, f)` (Línea 13763): This event is not emitted.
  - `def once(self, event, f)` (Línea 13770): Emitted when Browser context gets closed. This might happen because of one of the following:
- Browser context is closed.
- Browser application is closed or crashed.
- The `browser.close()` method was called.
  - `def once(self, event, f)` (Línea 13780): Emitted when JavaScript within the page calls one of console API methods, e.g. `console.log` or `console.dir`.
...
page.evaluate("console.log('hello', 5, { foo: 'bar' })")
```
  - `def once(self, event, f)` (Línea 13800): Emitted when a JavaScript dialog appears, such as `alert`, `prompt`, `confirm` or `beforeunload`. Listener **must**
either `dialog.accept()` or `dialog.dismiss()` the dialog - otherwise the page will
[freeze](https://developer.mozilla.org/en-US/docs/Web/JavaScript/EventLoop#never_blocking) waiting for the dialog,
and actions like click will never finish.
...
**NOTE** When no `page.on('dialog')` or `browser_context.on('dialog')` listeners are present, all dialogs are
automatically dismissed.
  - `def once(self, event, f)` (Línea 13819): Emitted when attachment download started in any page belonging to this context. User can access basic file
operations on downloaded content via the passed `Download` instance. See also `page.on('download')` to receive
events about a specific page.
  - `def once(self, event, f)` (Línea 13828): Emitted when a frame is attached in any page belonging to this context. See also `page.on('frame_attached')` to
receive events about a specific page.
  - `def once(self, event, f)` (Línea 13836): Emitted when a frame is detached in any page belonging to this context. See also `page.on('frame_detached')` to
receive events about a specific page.
  - `def once(self, event, f)` (Línea 13844): Emitted when a frame is navigated to a new url in any page belonging to this context. See also
`page.on('frame_navigated')` to receive events about navigations in a specific page.
  - `def once(self, event, f)` (Línea 13853): The event is emitted when a new Page is created in the BrowserContext. The page may still be loading. The event
will also fire for popup pages. See also `page.on('popup')` to receive events about popups relevant to a
specific page.
...
**NOTE** Use `page.wait_for_load_state()` to wait until the page gets to a particular state (you should not
need it in most cases).
  - `def once(self, event, f)` (Línea 13878): Emitted when a page in this context is closed. See also `page.on('close')` to receive events about a specific
page.
  - `def once(self, event, f)` (Línea 13886): Emitted when the JavaScript [`load`](https://developer.mozilla.org/en-US/docs/Web/Events/load) event is dispatched
in any page belonging to this context. See also `page.on('load')` to receive events about a specific page.
  - `def once(self, event, f)` (Línea 13895): Emitted when exception is unhandled in any of the pages in this context. To listen for errors from a particular
page, use `page.on('page_error')` instead.
  - `def once(self, event, f)` (Línea 13903): Emitted when a request is issued from any pages created through this context. The [request] object is read-only. To
only listen for requests from a particular page, use `page.on('request')`.

In order to intercept and mutate requests, see `browser_context.route()` or `page.route()`.
  - `def once(self, event, f)` (Línea 13914): Emitted when a request fails, for example by timing out. To only listen for failed requests from a particular page,
use `page.on('request_failed')`.

**NOTE** HTTP Error responses, such as 404 or 503, are still successful responses from HTTP standpoint, so request
will complete with `browser_context.on('request_finished')` event and not with
`browser_context.on('request_failed')`.
  - `def once(self, event, f)` (Línea 13926): Emitted when a request finishes successfully after downloading the response body. For a successful response, the
sequence of events is `request`, `response` and `requestfinished`. To listen for successful requests from a
particular page, use `page.on('request_finished')`.
  - `def once(self, event, f)` (Línea 13935): Emitted when [response] status and headers are received for a request. For a successful response, the sequence of
events is `request`, `response` and `requestfinished`. To listen for response events from a particular page, use
`page.on('response')`.
  - `def once(self, event, f)` (Línea 13944): **NOTE** Service workers are only supported on Chromium-based browsers.

Emitted when new service worker is created in the context.
  - `def once(self, event, f)` (Línea 13952): Sin docstring.
  - `def pages(self)` (Línea 13956): BrowserContext.pages
...
-------
List[Page]
  - `def browser(self)` (Línea 13968): BrowserContext.browser
...
-------
Union[Browser, None]
  - `def background_pages(self)` (Línea 13981): BrowserContext.background_pages
...
-------
List[Page]
  - `def service_workers(self)` (Línea 13993): BrowserContext.service_workers
...
-------
List[Worker]
  - `def tracing(self)` (Línea 14007): BrowserContext.tracing

Returns
-------
Tracing
  - `def debugger(self)` (Línea 14017): BrowserContext.debugger
...
-------
Debugger
  - `def request(self)` (Línea 14029): BrowserContext.request
...
-------
APIRequestContext
  - `def clock(self)` (Línea 14041): BrowserContext.clock
...
-------
Clock
  - `def set_default_navigation_timeout(self, timeout)` (Línea 14052): BrowserContext.set_default_navigation_timeout
...
timeout : float
    Maximum navigation time in milliseconds
  - `def set_default_timeout(self, timeout)` (Línea 14080): BrowserContext.set_default_timeout
...
timeout : float
    Maximum time in milliseconds. Pass `0` to disable timeout.
  - `def new_page(self)` (Línea 14101): BrowserContext.new_page
...
-------
Page
  - `def cookies(self, urls)` (Línea 14113): BrowserContext.cookies
...
List[{name: str, value: str, domain: str, path: str, expires: float, httpOnly: bool, secure: bool, sameSite: Union["Lax", "None", "Strict"], partitionKey: Union[str, None]}]
  - `def add_cookies(self, cookies)` (Línea 14135): BrowserContext.add_cookies
...
cookies : Sequence[{name: str, value: str, url: Union[str, None], domain: Union[str, None], path: Union[str, None], expires: Union[float, None], httpOnly: Union[bool, None], secure: Union[bool, None], sameSite: Union["Lax", "None", "Strict", None], partitionKey: Union[str, None]}]
  - `def clear_cookies(self)` (Línea 14156): BrowserContext.clear_cookies
...
path : Union[Pattern[str], str, None]
  ...
  - `def grant_permissions(self, permissions)` (Línea 14193): BrowserContext.grant_permissions
...
origin : Union[str, None]
  ...
  - `def clear_permissions(self)` (Línea 14240): BrowserContext.clear_permissions
...
```
  - `def set_geolocation(self, geolocation)` (Línea 14257): BrowserContext.set_geolocation
...
geolocation : Union[{latitude: float, longitude: float, accuracy: Union[float, None]}, None]
  - `def set_extra_http_headers(self, headers)` (Línea 14280): BrowserContext.set_extra_http_headers
...
headers : Dict[str, str]
    An object containing additional HTTP headers to be sent with every request. All header values must be strings.
  - `def set_offline(self, offline)` (Línea 14302): BrowserContext.set_offline

Parameters
----------
offline : bool
    Whether to emulate network being offline for the browser context.
  - `def add_init_script(self, script)` (Línea 14315): BrowserContext.add_init_script
...
-------
SyncContextManager
  - `def expose_binding(self, name, callback)` (Línea 14360): BrowserContext.expose_binding
...
-------
SyncContextManager
  - `def expose_function(self, name, callback)` (Línea 14422): BrowserContext.expose_function
...
-------
SyncContextManager
  - `def route(self, url, handler)` (Línea 14488): BrowserContext.route
...
-------
SyncContextManager
  - `def unroute(self, url, handler)` (Línea 14576): BrowserContext.unroute
...
handler : Union[Callable[[Route, Request], Any], Callable[[Route], Any], None]
  ...
  - `def route_web_socket(self, url, handler)` (Línea 14608): BrowserContext.route_web_socket
...
handler : Callable[[WebSocketRoute], Any]
    Handler function to route the WebSocket.
  - `def unroute_all(self)` (Línea 14655): BrowserContext.unroute_all
...
behavior : Union["default", "ignoreErrors", "wait", None]
    ...
    - `'ignoreErrors'` - do not wait for current handler calls (if any) to finish, all errors thrown by the handlers
      after unrouting are silently caught
  - `def route_from_har(self, har)` (Línea 14679): BrowserContext.route_from_har
...
update_mode : Union["full", "minimal", None]
    ...
    cookies, security and other types of HAR information that are not used when replaying from HAR. Defaults to
    `minimal`.
  - `def expect_event(self, event, predicate)` (Línea 14737): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14746): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14755): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14764): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14773): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14782): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14791): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14800): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14809): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14818): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14827): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14836): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14845): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14854): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14863): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14872): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14881): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14890): Sin docstring.
  - `def expect_event(self, event, predicate)` (Línea 14898): BrowserContext.expect_event
...
-------
EventContextManager
  - `def is_closed(self)` (Línea 14941): BrowserContext.is_closed
...
-------
bool
  - `def close(self)` (Línea 14953): BrowserContext.close
...
reason : Union[str, None]
  ...
  - `def storage_state(self)` (Línea 14968): BrowserContext.storage_state
...
{cookies: List[{name: str, value: str, domain: str, path: str, expires: float, httpOnly: bool, secure: bool, sameSite: Union["Lax", "None", "Strict"]}], origins: List[{origin: str, localStorage: List[{name: str, value: str}]}]}
  - `def set_storage_state(self, storage_state)` (Línea 14998): BrowserContext.set_storage_state
...
storage_state : Union[pathlib.Path, str, {cookies: Sequence[{name: str, value: str, domain: str, path: str, expires: float, httpOnly: bool, secure: bool, sameSite: Union["Lax", "None", "Strict"]}], origins: Sequence[{origin: str, localStorage: Sequence[{name: str, value: str}]}]}]
  ...
  - `def wait_for_event(self, event, predicate)` (Línea 15026): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15035): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15044): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15053): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15062): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15071): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15080): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15089): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15098): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15107): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15116): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15125): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15134): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15143): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15152): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15161): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15170): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15179): Sin docstring.
  - `def wait_for_event(self, event, predicate)` (Línea 15187): BrowserContext.wait_for_event
...
-------
Any
  - `def expect_console_message(self, predicate)` (Línea 15227): BrowserContext.expect_console_message
...
-------
EventContextManager[ConsoleMessage]
  - `def expect_page(self, predicate)` (Línea 15260): BrowserContext.expect_page
...
-------
EventContextManager[Page]
  - `def new_cdp_session(self, page)` (Línea 15292): BrowserContext.new_cdp_session
...
#### Clase `CDPSession` (Línea 15316)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def on(self, event, f)` (Línea 15319): Emitted when the session is closed, either because the target was closed or `session.detach()` was called.
  - `def on(self, event, f)` (Línea 15327): Sin docstring.
  - `def on(self, event, f)` (Línea 15329): Sin docstring.
  - `def once(self, event, f)` (Línea 15333): Emitted when the session is closed, either because the target was closed or `session.detach()` was called.
  - `def once(self, event, f)` (Línea 15341): Sin docstring.
  - `def once(self, event, f)` (Línea 15343): Sin docstring.
  - `def send(self, method, params)` (Línea 15346): CDPSession.send
...
-------
Dict
  - `def detach(self)` (Línea 15369): CDPSession.detach

Detaches the CDPSession from the target. Once detached, the CDPSession object won't emit any events and can't be
used to send messages.

#### Clase `Browser` (Línea 15382)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def on(self, event, f)` (Línea 15385): Emitted when a new browser context is created.
  - `def on(self, event, f)` (Línea 15392): Emitted when Browser gets disconnected from the browser application. This might happen because of one of the
following:
- Browser application is closed or crashed.
- The `browser.close()` method was called.
  - `def on(self, event, f)` (Línea 15401): Sin docstring.
  - `def once(self, event, f)` (Línea 15405): Emitted when a new browser context is created.
  - `def once(self, event, f)` (Línea 15412): Emitted when Browser gets disconnected from the browser application. This might happen because of one of the
following:
- Browser application is closed or crashed.
- The `browser.close()` method was called.
  - `def once(self, event, f)` (Línea 15421): Sin docstring.
  - `def contexts(self)` (Línea 15425): Browser.contexts
...
-------
List[BrowserContext]
  - `def browser_type(self)` (Línea 15446): Browser.browser_type
...
-------
BrowserType
  - `def version(self)` (Línea 15458): Browser.version
...
-------
str
  - `def is_connected(self)` (Línea 15469): Browser.is_connected
...
-------
bool
  - `def new_context(self)` (Línea 15481): Browser.new_context
...
-------
BrowserContext
  - `def new_page(self)` (Línea 15734): Browser.new_page
...
-------
Page
  - `def close(self)` (Línea 15971): Browser.close
...
reason : Union[str, None]
  ...
  - `def new_browser_cdp_session(self)` (Línea 15994): Browser.new_browser_cdp_session
...
-------
CDPSession
  - `def bind(self, title)` (Línea 16008): Browser.bind
...
-------
{endpoint: str}
  - `def unbind(self)` (Línea 16045): Browser.unbind

Unbinds the browser server previously bound with `browser.bind()`.
  - `def start_tracing(self)` (Línea 16053): Browser.start_tracing
...
categories : Union[Sequence[str], None]
  ...
  - `def stop_tracing(self)` (Línea 16102): Browser.stop_tracing
...
#### Clase `BrowserType` (Línea 16123)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def name(self)` (Línea 16126): BrowserType.name
...
-------
str
  - `def executable_path(self)` (Línea 16138): BrowserType.executable_path
...
-------
str
  - `def launch(self)` (Línea 16149): BrowserType.launch
...
-------
Browser
  - `def launch_persistent_context(self, user_data_dir)` (Línea 16292): BrowserType.launch_persistent_context
...
-------
BrowserContext
  - `def connect_over_cdp(self, endpoint_url)` (Línea 16627): BrowserType.connect_over_cdp
...
-------
Browser
  - `def connect(self, endpoint)` (Línea 16698): BrowserType.connect
...
#### Clase `Playwright` (Línea 16761)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def devices(self)` (Línea 16764): Playwright.devices
...
-------
Dict
  - `def selectors(self)` (Línea 16793): Playwright.selectors
...
-------
Selectors
  - `def chromium(self)` (Línea 16806): Playwright.chromium
...
-------
BrowserType
  - `def firefox(self)` (Línea 16818): Playwright.firefox
...
-------
BrowserType
  - `def webkit(self)` (Línea 16830): Playwright.webkit
...
-------
BrowserType
  - `def request(self)` (Línea 16842): Playwright.request
...
-------
APIRequest
  - `def __getitem__(self, value)` (Línea 16853): Sin docstring.
  - `def stop(self)` (Línea 16857): Playwright.stop
...
#### Clase `Tracing` (Línea 16884)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def start(self)` (Línea 16886): Tracing.start
...
live : Union[bool, None]
    ...
    execution.
  - `def start_chunk(self)` (Línea 16953): Tracing.start_chunk
...
name : Union[str, None]
  ...
  - `def stop_chunk(self)` (Línea 16994): Tracing.stop_chunk
...
path : Union[pathlib.Path, str, None]
  ...
  - `def stop(self)` (Línea 17009): Tracing.stop
...
path : Union[pathlib.Path, str, None]
  ...
  - `def group(self, name)` (Línea 17024): Tracing.group
...
-------
SyncContextManager
  - `def group_end(self)` (Línea 17062): Tracing.group_end

Closes the last group created by `tracing.group()`.
  - `def start_har(self, path)` (Línea 17070): Tracing.start_har
...
-------
SyncContextManager
  - `def stop_har(self)` (Línea 17123): Tracing.stop_har

Stop HAR recording and save the HAR file to the path given to `tracing.start_har()`.

#### Clase `Locator` (Línea 17135)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def page(self)` (Línea 17138): Locator.page
...
-------
Page
  - `def first(self)` (Línea 17150): Locator.first
...
-------
Locator
  - `def last(self)` (Línea 17162): Locator.last
...
-------
Locator
  - `def content_frame(self)` (Línea 17180): Locator.content_frame
...
-------
FrameLocator
  - `def description(self)` (Línea 17206): Locator.description
...
-------
Union[str, None]
  - `def bounding_box(self)` (Línea 17228): Locator.bounding_box
...
-------
Union[{x: float, y: float, width: float, height: float}, None]
  - `def check(self)` (Línea 17273): Locator.check
...
trial : Union[bool, None]
    When set, this method only performs the [actionability](../actionability.md) checks and skips the action. Defaults
    to `false`. Useful to wait until the element is ready for the action without performing it.
  - `def click(self)` (Línea 17337): Locator.click
...
steps : Union[int, None]
    Defaults to 1. Sends `n` interpolated `mousemove` events to represent travel between Playwright's current cursor
    position and the provided destination. When set to 1, emits a single `mousemove` event at the destination location.
  - `def dblclick(self)` (Línea 17438): Locator.dblclick
...
steps : Union[int, None]
    Defaults to 1. Sends `n` interpolated `mousemove` events to represent travel between Playwright's current cursor
    position and the provided destination. When set to 1, emits a single `mousemove` event at the destination location.
  - `def dispatch_event(self, type, event_init)` (Línea 17518): Locator.dispatch_event
...
timeout : Union[float, None]
    Maximum time in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can
    be changed by using the `browser_context.set_default_timeout()` or `page.set_default_timeout()` methods.
  - `def evaluate(self, expression, arg)` (Línea 17584): Locator.evaluate
...
-------
Any
  - `def evaluate_all(self, expression, arg)` (Línea 17639): Locator.evaluate_all
...
-------
Any
  - `def evaluate_handle(self, expression, arg)` (Línea 17683): Locator.evaluate_handle
...
-------
JSHandle
  - `def fill(self, value)` (Línea 17735): Locator.fill
...
force : Union[bool, None]
    Whether to bypass the [actionability](../actionability.md) checks. Defaults to `false`.
  - `def clear(self)` (Línea 17790): Locator.clear
...
force : Union[bool, None]
    Whether to bypass the [actionability](../actionability.md) checks. Defaults to `false`.
  - `def locator(self, selector_or_locator)` (Línea 17839): Locator.locator
...
-------
Locator
  - `def get_by_alt_text(self, text)` (Línea 17897): Locator.get_by_alt_text
...
-------
Locator
  - `def get_by_label(self, text)` (Línea 17934): Locator.get_by_label
...
-------
Locator
  - `def get_by_placeholder(self, text)` (Línea 17975): Locator.get_by_placeholder
...
-------
Locator
  - `def get_by_role(self, role)` (Línea 18016): Locator.get_by_role
...
-------
Locator
  - `def get_by_test_id(self, test_id)` (Línea 18224): Locator.get_by_test_id
...
-------
Locator
  - `def get_by_text(self, text)` (Línea 18262): Locator.get_by_text
...
-------
Locator
  - `def get_by_title(self, text)` (Línea 18326): Locator.get_by_title
...
-------
Locator
  - `def frame_locator(self, selector)` (Línea 18365): Locator.frame_locator
...
-------
FrameLocator
  - `def element_handle(self)` (Línea 18390): Locator.element_handle
...
-------
ElementHandle
  - `def element_handles(self)` (Línea 18415): Locator.element_handles
...
-------
List[ElementHandle]
  - `def nth(self, index)` (Línea 18427): Locator.nth
...
-------
Locator
  - `def describe(self, description)` (Línea 18449): Locator.describe
...
-------
Locator
  - `def filter(self)` (Línea 18474): Locator.filter
...
-------
Locator
  - `def or_(self, locator)` (Línea 18540): Locator.or_
...
-------
Locator
  - `def and_(self, locator)` (Línea 18578): Locator.and_
...
-------
Locator
  - `def focus(self)` (Línea 18603): Locator.focus
...
timeout : Union[float, None]
    Maximum time in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can
    be changed by using the `browser_context.set_default_timeout()` or `page.set_default_timeout()` methods.
  - `def blur(self)` (Línea 18623): Locator.blur
...
timeout : Union[float, None]
    Maximum time in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can
    be changed by using the `browser_context.set_default_timeout()` or `page.set_default_timeout()` methods.
  - `def all(self)` (Línea 18643): Locator.all
...
-------
List[Locator]
  - `def count(self)` (Línea 18672): Locator.count
...
-------
int
  - `def drag_to(self, target)` (Línea 18693): Locator.drag_to
...
steps : Union[int, None]
    Defaults to 1. Sends `n` interpolated `mousemove` events to represent travel between the `mousedown` and `mouseup`
    of the drag. When set to 1, emits a single `mousemove` event at the destination location.
  - `def drop(self, payload)` (Línea 18770): Locator.drop
...
timeout : Union[float, None]
    Maximum time in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can
    be changed by using the `browser_context.set_default_timeout()` or `page.set_default_timeout()` methods.
  - `def get_attribute(self, name)` (Línea 18817): Locator.get_attribute
...
-------
Union[str, None]
  - `def hover(self)` (Línea 18851): Locator.hover
...
trial : Union[bool, None]
    ...
    `modifiers` will be pressed regardless of `trial` to allow testing elements which are only visible when those keys
    are pressed.
  - `def inner_html(self)` (Línea 18922): Locator.inner_html
...
-------
str
  - `def inner_text(self)` (Línea 18946): Locator.inner_text
...
-------
str
  - `def input_value(self)` (Línea 18973): Locator.input_value
...
-------
str
  - `def is_checked(self)` (Línea 19013): Locator.is_checked
...
-------
bool
  - `def is_disabled(self)` (Línea 19046): Locator.is_disabled
...
-------
bool
  - `def is_editable(self)` (Línea 19079): Locator.is_editable
...
-------
bool
  - `def is_enabled(self)` (Línea 19114): Locator.is_enabled
...
-------
bool
  - `def is_hidden(self)` (Línea 19147): Locator.is_hidden
...
-------
bool
  - `def is_visible(self)` (Línea 19179): Locator.is_visible
...
-------
bool
  - `def press(self, key)` (Línea 19211): Locator.press
...
no_wait_after : Union[bool, None]
    ...
    navigating to inaccessible pages. Defaults to `false`.
    Deprecated: This option will default to `true` in the future.
  - `def screenshot(self)` (Línea 19280): Locator.screenshot
...
-------
bytes
  - `def aria_snapshot(self)` (Línea 19390): Locator.aria_snapshot
...
-------
str
  - `def normalize(self)` (Línea 19473): Locator.normalize
...
-------
Locator
  - `def scroll_into_view_if_needed(self)` (Línea 19487): Locator.scroll_into_view_if_needed
...
timeout : Union[float, None]
    Maximum time in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can
    be changed by using the `browser_context.set_default_timeout()` or `page.set_default_timeout()` methods.
  - `def select_option(self, value)` (Línea 19515): Locator.select_option
...
-------
List[str]
  - `def select_text(self)` (Línea 19605): Locator.select_text
...
timeout : Union[float, None]
    Maximum time in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can
    be changed by using the `browser_context.set_default_timeout()` or `page.set_default_timeout()` methods.
  - `def set_input_files(self, files)` (Línea 19637): Locator.set_input_files
...
no_wait_after : Union[bool, None]
    This option has no effect.
    Deprecated: This option has no effect.
  - `def tap(self)` (Línea 19709): Locator.tap
...
trial : Union[bool, None]
    ...
    `modifiers` will be pressed regardless of `trial` to allow testing elements which are only visible when those keys
    are pressed.
  - `def text_content(self)` (Línea 19777): Locator.text_content
...
-------
Union[str, None]
  - `def type(self, text)` (Línea 19804): Locator.type
...
no_wait_after : Union[bool, None]
    This option has no effect.
    Deprecated: This option has no effect.
  - `def press_sequentially(self, text)` (Línea 19846): Locator.press_sequentially
...
no_wait_after : Union[bool, None]
    This option has no effect.
    Deprecated: This option has no effect.
  - `def uncheck(self)` (Línea 19904): Locator.uncheck
...
trial : Union[bool, None]
    When set, this method only performs the [actionability](../actionability.md) checks and skips the action. Defaults
    to `false`. Useful to wait until the element is ready for the action without performing it.
  - `def all_inner_texts(self)` (Línea 19968): Locator.all_inner_texts
...
-------
List[str]
  - `def all_text_contents(self)` (Línea 19989): Locator.all_text_contents
...
-------
List[str]
  - `def wait_for(self)` (Línea 20010): Locator.wait_for
...
state : Union["attached", "detached", "hidden", "visible", None]
    ...
    - `'hidden'` - wait for element to be either detached from DOM, or have an empty bounding box or
      `visibility:hidden`. This is opposite to the `'visible'` option.
  - `def set_checked(self, checked)` (Línea 20053): Locator.set_checked
...
trial : Union[bool, None]
    When set, this method only performs the [actionability](../actionability.md) checks and skips the action. Defaults
    to `false`. Useful to wait until the element is ready for the action without performing it.
  - `def highlight(self)` (Línea 20120): Locator.highlight
...
style : Union[str, None]
  ...
  - `def hide_highlight(self)` (Línea 20136): Locator.hide_highlight

Hides the element highlight previously added by `locator.highlight()`.

#### Clase `APIResponse` (Línea 20148)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def ok(self)` (Línea 20151): APIResponse.ok
...
-------
bool
  - `def url(self)` (Línea 20163): APIResponse.url
...
-------
str
  - `def status(self)` (Línea 20175): APIResponse.status
...
-------
int
  - `def status_text(self)` (Línea 20187): APIResponse.status_text
...
-------
str
  - `def headers(self)` (Línea 20199): APIResponse.headers
...
-------
Dict[str, str]
  - `def headers_array(self)` (Línea 20211): APIResponse.headers_array
...
-------
List[{name: str, value: str}]
  - `def body(self)` (Línea 20223): APIResponse.body
...
-------
bytes
  - `def text(self)` (Línea 20235): APIResponse.text
...
-------
str
  - `def json(self)` (Línea 20247): APIResponse.json
...
-------
Any
  - `def dispose(self)` (Línea 20261): APIResponse.dispose

Disposes the body of this response. If not called then the body will stay in memory until the context closes.

#### Clase `APIRequestContext` (Línea 20273)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def tracing(self)` (Línea 20276): APIRequestContext.tracing

Returns
-------
Tracing
  - `def dispose(self)` (Línea 20285): APIRequestContext.dispose
...
reason : Union[str, None]
  ...
  - `def delete(self, url)` (Línea 20302): APIRequestContext.delete
...
-------
APIResponse
  - `def head(self, url)` (Línea 20392): APIRequestContext.head
...
-------
APIResponse
  - `def get(self, url)` (Línea 20482): APIRequestContext.get
...
-------
APIResponse
  - `def patch(self, url)` (Línea 20584): APIRequestContext.patch
...
-------
APIResponse
  - `def put(self, url)` (Línea 20674): APIRequestContext.put
...
-------
APIResponse
  - `def post(self, url)` (Línea 20764): APIRequestContext.post
...
-------
APIResponse
  - `def fetch(self, url_or_request)` (Línea 20885): APIRequestContext.fetch
...
-------
APIResponse
  - `def storage_state(self)` (Línea 20998): APIRequestContext.storage_state
...
#### Clase `APIRequest` (Línea 21030)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def new_context(self)` (Línea 21032): APIRequest.new_context
...
#### Clase `PageAssertions` (Línea 21135)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def to_have_title(self, title_or_reg_exp)` (Línea 21137): PageAssertions.to_have_title
...
timeout : Union[float, None]
  ...
  - `def not_to_have_title(self, title_or_reg_exp)` (Línea 21174): PageAssertions.not_to_have_title
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_have_url(self, url_or_reg_exp)` (Línea 21201): PageAssertions.to_have_url
...
ignore_case : Union[bool, None]
  ...
  - `def not_to_have_url(self, url_or_reg_exp)` (Línea 21244): PageAssertions.not_to_have_url
...
ignore_case : Union[bool, None]
  ...
  - `def to_match_aria_snapshot(self, expected)` (Línea 21277): PageAssertions.to_match_aria_snapshot
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_match_aria_snapshot(self, expected)` (Línea 21313): PageAssertions.not_to_match_aria_snapshot
...
#### Clase `LocatorAssertions` (Línea 21343)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def to_contain_text(self, expected)` (Línea 21345): LocatorAssertions.to_contain_text
...
ignore_case : Union[bool, None]
    Whether to perform case-insensitive match. `ignoreCase` option takes precedence over the corresponding regular
    expression flag if specified.
  - `def not_to_contain_text(self, expected)` (Línea 21439): LocatorAssertions.not_to_contain_text
...
ignore_case : Union[bool, None]
    Whether to perform case-insensitive match. `ignoreCase` option takes precedence over the corresponding regular
    expression flag if specified.
  - `def to_have_attribute(self, name, value)` (Línea 21482): LocatorAssertions.to_have_attribute
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_have_attribute(self, name, value)` (Línea 21528): LocatorAssertions.not_to_have_attribute
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_have_class(self, expected)` (Línea 21565): LocatorAssertions.to_have_class
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_have_class(self, expected)` (Línea 21624): LocatorAssertions.not_to_have_class
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_contain_class(self, expected)` (Línea 21657): LocatorAssertions.to_contain_class
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_contain_class(self, expected)` (Línea 21720): LocatorAssertions.not_to_contain_class
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_have_count(self, count)` (Línea 21747): LocatorAssertions.to_have_count
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_have_count(self, count)` (Línea 21783): LocatorAssertions.not_to_have_count
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_have_css(self, name, value)` (Línea 21810): LocatorAssertions.to_have_css
...
pseudo : Union["after", "before", None]
  ...
  - `def not_to_have_css(self, name, value)` (Línea 21855): LocatorAssertions.not_to_have_css
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_have_id(self, id)` (Línea 21885): LocatorAssertions.to_have_id
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_have_id(self, id)` (Línea 21919): LocatorAssertions.not_to_have_id
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_have_js_property(self, name, value)` (Línea 21944): LocatorAssertions.to_have_js_property
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_have_js_property(self, name, value)` (Línea 21986): LocatorAssertions.not_to_have_js_property
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_have_value(self, value)` (Línea 22018): LocatorAssertions.to_have_value
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_have_value(self, value)` (Línea 22056): LocatorAssertions.not_to_have_value
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_have_values(self, values)` (Línea 22083): LocatorAssertions.to_have_values
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_have_values(self, values)` (Línea 22136): LocatorAssertions.not_to_have_values
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_have_text(self, expected)` (Línea 22167): LocatorAssertions.to_have_text
...
ignore_case : Union[bool, None]
    Whether to perform case-insensitive match. `ignoreCase` option takes precedence over the corresponding regular
    expression flag if specified.
  - `def not_to_have_text(self, expected)` (Línea 22260): LocatorAssertions.not_to_have_text
...
ignore_case : Union[bool, None]
    Whether to perform case-insensitive match. `ignoreCase` option takes precedence over the corresponding regular
    expression flag if specified.
  - `def to_be_attached(self)` (Línea 22303): LocatorAssertions.to_be_attached
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_be_checked(self)` (Línea 22336): LocatorAssertions.to_be_checked
...
indeterminate : Union[bool, None]
  ...
  - `def not_to_be_attached(self)` (Línea 22379): LocatorAssertions.not_to_be_attached
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_be_checked(self)` (Línea 22405): LocatorAssertions.not_to_be_checked
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_be_disabled(self)` (Línea 22427): LocatorAssertions.to_be_disabled
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_be_disabled(self)` (Línea 22460): LocatorAssertions.not_to_be_disabled
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_be_editable(self)` (Línea 22482): LocatorAssertions.to_be_editable
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_be_editable(self)` (Línea 22517): LocatorAssertions.not_to_be_editable
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_be_empty(self)` (Línea 22543): LocatorAssertions.to_be_empty
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_be_empty(self)` (Línea 22572): LocatorAssertions.not_to_be_empty
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_be_enabled(self)` (Línea 22592): LocatorAssertions.to_be_enabled
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_be_enabled(self)` (Línea 22627): LocatorAssertions.not_to_be_enabled
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_be_hidden(self)` (Línea 22653): LocatorAssertions.to_be_hidden
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_be_hidden(self)` (Línea 22683): LocatorAssertions.not_to_be_hidden
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_be_visible(self)` (Línea 22705): LocatorAssertions.to_be_visible
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_be_visible(self)` (Línea 22750): LocatorAssertions.not_to_be_visible
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_be_focused(self)` (Línea 22776): LocatorAssertions.to_be_focused
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_be_focused(self)` (Línea 22805): LocatorAssertions.not_to_be_focused
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_be_in_viewport(self)` (Línea 22827): LocatorAssertions.to_be_in_viewport
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_be_in_viewport(self)` (Línea 22870): LocatorAssertions.not_to_be_in_viewport
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_have_accessible_description(self, description)` (Línea 22896): LocatorAssertions.to_have_accessible_description
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_have_accessible_description(self, name)` (Línea 22937): LocatorAssertions.not_to_have_accessible_description
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_have_accessible_name(self, name)` (Línea 22968): LocatorAssertions.to_have_accessible_name
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_have_accessible_name(self, name)` (Línea 23007): LocatorAssertions.not_to_have_accessible_name
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_have_role(self, role)` (Línea 23038): LocatorAssertions.to_have_role
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_have_accessible_error_message(self, error_message)` (Línea 23156): LocatorAssertions.to_have_accessible_error_message
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_have_accessible_error_message(self, error_message)` (Línea 23197): LocatorAssertions.not_to_have_accessible_error_message
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_have_role(self, role)` (Línea 23230): LocatorAssertions.not_to_have_role
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def to_match_aria_snapshot(self, expected)` (Línea 23340): LocatorAssertions.to_match_aria_snapshot
...
timeout : Union[float, None]
    Time to retry the assertion for in milliseconds. Defaults to `5000`.
  - `def not_to_match_aria_snapshot(self, expected)` (Línea 23376): LocatorAssertions.not_to_match_aria_snapshot
...
#### Clase `APIResponseAssertions` (Línea 23406)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def to_be_ok(self)` (Línea 23408): APIResponseAssertions.to_be_ok
...
```
  - `def not_to_be_ok(self)` (Línea 23427): APIResponseAssertions.not_to_be_ok

The opposite of `a_pi_response_assertions.to_be_ok()`.

#### Clase `Disposable` (Línea 23440)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def dispose(self)` (Línea 23442): Disposable.dispose
...
or `browser_context.add_init_script()`.
  - `def close(self)` (Línea 23451): Sin docstring.
