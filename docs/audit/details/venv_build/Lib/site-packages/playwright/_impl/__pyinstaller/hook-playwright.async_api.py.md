# Documentación Técnica: `venv_build/Lib/site-packages/playwright/_impl/__pyinstaller/hook-playwright.async_api.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/_impl/__pyinstaller/hook-playwright.async_api.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 17
