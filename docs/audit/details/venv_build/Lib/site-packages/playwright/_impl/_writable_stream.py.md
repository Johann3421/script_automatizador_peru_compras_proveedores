# Documentación Técnica: `venv_build/Lib/site-packages/playwright/_impl/_writable_stream.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/playwright/_impl/_writable_stream.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 42
...
#### Clase `WritableStream` (Línea 27)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def __init__(self, parent, type, guid, initializer)` (Línea 28): Sin docstring.
  - `def copy(self, path)` (Línea 33): Sin docstring.
