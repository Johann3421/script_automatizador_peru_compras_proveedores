# Documentación Técnica: `venv_build/Lib/site-packages/idna/uts46data.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/idna/uts46data.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16896
