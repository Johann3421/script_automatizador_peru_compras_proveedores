# Documentación Técnica: `venv_build/Lib/site-packages/win32ctypes/core/cffi/_time.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32ctypes/core/cffi/_time.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
...
#### `def _GetTickCount()` (Línea 17)
- **Propósito:** Sin docstring.
- **Firma:** `def _GetTickCount()`
