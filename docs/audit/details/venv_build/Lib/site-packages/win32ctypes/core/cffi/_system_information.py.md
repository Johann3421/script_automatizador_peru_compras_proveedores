# Documentación Técnica: `venv_build/Lib/site-packages/win32ctypes/core/cffi/_system_information.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32ctypes/core/cffi/_system_information.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 32
...
#### `def _GetWindowsDirectory()` (Línea 23)
- **Propósito:** Sin docstring.
- **Firma:** `def _GetWindowsDirectory()`
- **Retorno / Efectos:** Consulta código fuente.

#### `def _GetSystemDirectory()` (Línea 29)
- **Propósito:** Sin docstring.
- **Firma:** `def _GetSystemDirectory()`
- **Retorno / Efectos:** Consulta código fuente.
