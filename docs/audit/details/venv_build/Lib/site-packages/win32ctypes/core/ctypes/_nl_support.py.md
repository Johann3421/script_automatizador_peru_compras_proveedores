# Documentación Técnica: `venv_build/Lib/site-packages/win32ctypes/core/ctypes/_nl_support.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32ctypes/core/ctypes/_nl_support.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 12
