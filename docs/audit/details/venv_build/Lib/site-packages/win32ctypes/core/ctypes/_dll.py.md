# Documentación Técnica: `venv_build/Lib/site-packages/win32ctypes/core/ctypes/_dll.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32ctypes/core/ctypes/_dll.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 21
