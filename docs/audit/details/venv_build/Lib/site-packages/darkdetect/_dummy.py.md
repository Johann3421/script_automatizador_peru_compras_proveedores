# Documentación Técnica: `venv_build/Lib/site-packages/darkdetect/_dummy.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/darkdetect/_dummy.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 19
...
#### `def isLight()` (Línea 15)
- **Propósito:** Sin docstring.
- **Firma:** `def isLight()`
- **Retorno / Efectos:** Consulta código fuente.

#### `def listener(callback)` (Línea 18)
- **Propósito:** Sin docstring.
