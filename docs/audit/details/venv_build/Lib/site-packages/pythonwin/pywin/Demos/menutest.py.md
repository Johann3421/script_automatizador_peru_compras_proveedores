# Documentación Técnica: `venv_build/Lib/site-packages/pythonwin/pywin/Demos/menutest.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pythonwin/pywin/Demos/menutest.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 13
