# Documentación Técnica: `venv_build/Lib/site-packages/pythonwin/pywin/framework/startup.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pythonwin/pywin/framework/startup.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 70
