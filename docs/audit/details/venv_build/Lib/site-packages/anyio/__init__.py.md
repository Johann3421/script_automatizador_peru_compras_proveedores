# Documentación Técnica: `venv_build/Lib/site-packages/anyio/__init__.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/anyio/__init__.py`
- **Tipo de archivo:** `.py`
...
#### `def __getattr__(attr)` (Línea 103)
- **Propósito:** Support deprecated aliases.
- **Firma:** `def __getattr__(attr)`
