# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-adbc_driver_manager.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-adbc_driver_manager.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 17
