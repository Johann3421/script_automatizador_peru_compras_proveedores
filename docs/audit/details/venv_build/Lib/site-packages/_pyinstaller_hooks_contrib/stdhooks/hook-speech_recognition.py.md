# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-speech_recognition.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-speech_recognition.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
