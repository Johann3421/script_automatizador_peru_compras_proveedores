# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-sklearn.externals.array_api_compat.torch.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-sklearn.externals.array_api_compat.torch.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 21
