# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-astropy_iers_data.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-astropy_iers_data.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16
