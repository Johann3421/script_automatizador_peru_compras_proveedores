# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-moviepy.video.fx.all.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-moviepy.video.fx.all.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 17
