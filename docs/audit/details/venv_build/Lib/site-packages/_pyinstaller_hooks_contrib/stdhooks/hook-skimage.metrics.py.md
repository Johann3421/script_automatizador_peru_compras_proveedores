# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-skimage.metrics.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-skimage.metrics.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 19
