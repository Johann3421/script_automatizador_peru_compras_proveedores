# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-pylint.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-pylint.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 75
...
#### `def _filter_func(name)` (Línea 68)
- **Propósito:** Sin docstring.
- **Firma:** `def _filter_func(name)`
