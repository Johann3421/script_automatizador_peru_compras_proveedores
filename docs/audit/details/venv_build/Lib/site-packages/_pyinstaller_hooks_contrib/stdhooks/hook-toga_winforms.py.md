# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-toga_winforms.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-toga_winforms.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 46
