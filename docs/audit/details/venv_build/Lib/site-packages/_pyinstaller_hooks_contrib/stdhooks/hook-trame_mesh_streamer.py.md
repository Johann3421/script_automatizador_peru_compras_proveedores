# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-trame_mesh_streamer.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-trame_mesh_streamer.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16
