# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-pygraphviz.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-pygraphviz.py`
- **Tipo de archivo:** `.py`
...
#### `def _collect_graphviz_files()` (Línea 21)
- **Propósito:** Sin docstring.
- **Firma:** `def _collect_graphviz_files()`
