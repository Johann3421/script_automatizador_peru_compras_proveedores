# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-pyshark.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-pyshark.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 25
