# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-skimage.feature.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-skimage.feature.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 26
