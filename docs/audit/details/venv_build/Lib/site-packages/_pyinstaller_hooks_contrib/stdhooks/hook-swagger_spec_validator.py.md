# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-swagger_spec_validator.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-swagger_spec_validator.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 15
