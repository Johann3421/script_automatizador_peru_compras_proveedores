# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-sklearn.linear_model.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-sklearn.linear_model.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
