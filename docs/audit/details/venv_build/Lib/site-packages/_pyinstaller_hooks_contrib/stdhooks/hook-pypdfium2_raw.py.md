# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-pypdfium2_raw.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-pypdfium2_raw.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 19
