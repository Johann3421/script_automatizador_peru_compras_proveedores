# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-urllib3_future.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-urllib3_future.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16
