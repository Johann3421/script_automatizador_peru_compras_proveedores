# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-compliance_checker.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-compliance_checker.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 22
