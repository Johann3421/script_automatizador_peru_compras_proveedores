# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-imageio_ffmpeg.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-imageio_ffmpeg.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 22
