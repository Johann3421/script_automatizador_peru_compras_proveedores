# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-jsonpath_rw_ext.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-jsonpath_rw_ext.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 15
