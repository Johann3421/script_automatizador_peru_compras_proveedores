# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-google.cloud.storage.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-google.cloud.storage.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 15
