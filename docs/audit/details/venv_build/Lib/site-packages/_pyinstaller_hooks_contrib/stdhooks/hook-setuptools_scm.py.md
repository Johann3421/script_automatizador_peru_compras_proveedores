# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-setuptools_scm.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-setuptools_scm.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 17
