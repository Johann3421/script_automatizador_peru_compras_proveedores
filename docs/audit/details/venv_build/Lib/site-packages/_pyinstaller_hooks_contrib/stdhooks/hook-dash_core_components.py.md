# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-dash_core_components.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-dash_core_components.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 15
