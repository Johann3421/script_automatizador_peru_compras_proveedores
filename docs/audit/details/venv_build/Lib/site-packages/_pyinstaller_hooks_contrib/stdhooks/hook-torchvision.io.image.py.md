# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-torchvision.io.image.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-torchvision.io.image.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
