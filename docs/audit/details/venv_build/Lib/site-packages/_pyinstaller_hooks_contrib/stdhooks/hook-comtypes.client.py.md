# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-comtypes.client.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-comtypes.client.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 22
