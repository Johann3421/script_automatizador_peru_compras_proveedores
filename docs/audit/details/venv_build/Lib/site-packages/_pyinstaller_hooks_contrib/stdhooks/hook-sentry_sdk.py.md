# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-sentry_sdk.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-sentry_sdk.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 39
...
#### `def _get_integration_modules()` (Línea 28)
- **Propósito:** Sin docstring.
- **Firma:** `def _get_integration_modules()`
