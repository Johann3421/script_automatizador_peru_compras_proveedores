# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-dash_renderer.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-dash_renderer.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 15
