# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-google.cloud.bigquery.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/stdhooks/hook-google.cloud.bigquery.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16
