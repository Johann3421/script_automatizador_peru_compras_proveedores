# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/pre_safe_import_module/hook-tensorflow.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/pre_safe_import_module/hook-tensorflow.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 28
...
#### `def pre_safe_import_module(api)` (Línea 16)
