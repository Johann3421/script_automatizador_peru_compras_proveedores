# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/compat.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/compat.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 42
