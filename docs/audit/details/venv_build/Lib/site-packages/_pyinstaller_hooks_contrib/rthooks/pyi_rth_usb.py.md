# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/rthooks/pyi_rth_usb.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/rthooks/pyi_rth_usb.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 85
...
#### `def get_load_func(type, candidates)` (Línea 29)
- **Propósito:** Sin docstring.
- **Firma:** `def get_load_func(type, candidates)`
