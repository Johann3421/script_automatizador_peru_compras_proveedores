# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/rthooks/pyi_rth_traitlets.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/rthooks/pyi_rth_traitlets.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 25
...
#### `def _disabled_deprecation_warnings(method, cls, method_name, msg)` (Línea 21)
- **Propósito:** Sin docstring.
- **Firma:** `def _disabled_deprecation_warnings(method, cls, method_name, msg)`
