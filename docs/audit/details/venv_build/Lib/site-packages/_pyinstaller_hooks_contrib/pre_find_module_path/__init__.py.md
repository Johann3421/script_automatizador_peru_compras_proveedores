# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/pre_find_module_path/__init__.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/pre_find_module_path/__init__.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 11
