# Documentación Técnica: `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/__init__.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/_pyinstaller_hooks_contrib/__init__.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 47
...
#### `def get_hook_dirs()` (Línea 20)
- **Propósito:** Sin docstring.
- **Firma:** `def get_hook_dirs()`
