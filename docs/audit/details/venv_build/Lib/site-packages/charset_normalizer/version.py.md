# Documentación Técnica: `venv_build/Lib/site-packages/charset_normalizer/version.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/charset_normalizer/version.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 8
