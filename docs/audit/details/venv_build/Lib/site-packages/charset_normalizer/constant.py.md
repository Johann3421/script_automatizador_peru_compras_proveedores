# Documentación Técnica: `venv_build/Lib/site-packages/charset_normalizer/constant.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/charset_normalizer/constant.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 2050
