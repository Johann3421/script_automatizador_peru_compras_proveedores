# Documentación Técnica: `venv_build/Lib/site-packages/dateutil/tz/__init__.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/dateutil/tz/__init__.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 12
...
#### Clase `DeprecatedTzFormatWarning` (Línea 11)
- **Docstring:** _Warning raised when time zones are parsed from deprecated formats._
