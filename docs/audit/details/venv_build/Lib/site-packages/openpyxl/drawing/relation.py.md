# Documentación Técnica: `venv_build/Lib/site-packages/openpyxl/drawing/relation.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/openpyxl/drawing/relation.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 17
...
#### Clase `ChartRelation` (Línea 9)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def __init__(self, id)` (Línea 16): Sin docstring.
