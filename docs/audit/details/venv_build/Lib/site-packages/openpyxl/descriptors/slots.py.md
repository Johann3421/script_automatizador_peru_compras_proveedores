# Documentación Técnica: `venv_build/Lib/site-packages/openpyxl/descriptors/slots.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/openpyxl/descriptors/slots.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
...
#### Clase `AutoSlotProperties` (Línea 4)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def __new__(mcl, classname, bases, dictionary)` (Línea 6): Sin docstring.
