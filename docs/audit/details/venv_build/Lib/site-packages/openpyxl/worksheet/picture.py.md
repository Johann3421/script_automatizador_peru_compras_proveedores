# Documentación Técnica: `venv_build/Lib/site-packages/openpyxl/worksheet/picture.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/openpyxl/worksheet/picture.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 8
...
#### Clase `SheetBackgroundPicture` (Línea 6)
