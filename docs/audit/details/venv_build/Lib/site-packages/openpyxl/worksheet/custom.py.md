# Documentación Técnica: `venv_build/Lib/site-packages/openpyxl/worksheet/custom.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/openpyxl/worksheet/custom.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 35
...
#### Clase `CustomProperty` (Línea 11)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def __init__(self, name)` (Línea 17): Sin docstring.

#### Clase `CustomProperties` (Línea 23)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def __init__(self, customPr)` (Línea 31): Sin docstring.
