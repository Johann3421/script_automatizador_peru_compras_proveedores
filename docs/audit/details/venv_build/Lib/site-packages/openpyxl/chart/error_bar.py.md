# Documentación Técnica: `venv_build/Lib/site-packages/openpyxl/chart/error_bar.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/openpyxl/chart/error_bar.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 62
...
#### Clase `ErrorBars` (Línea 23)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def __init__(self, errDir, errBarType, errValType, noEndCap, plus, minus, val, spPr, extLst)` (Línea 44): Sin docstring.
