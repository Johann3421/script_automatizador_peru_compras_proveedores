# Documentación Técnica: `venv_build/Lib/site-packages/openpyxl/chart/picture.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/openpyxl/chart/picture.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 35
...
#### Clase `PictureOptions` (Línea 12)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def __init__(self, applyToFront, applyToSides, applyToEnd, pictureFormat, pictureStackUnit)` (Línea 24): Sin docstring.
