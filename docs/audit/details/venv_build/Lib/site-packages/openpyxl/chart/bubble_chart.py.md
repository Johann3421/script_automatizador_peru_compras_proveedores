# Documentación Técnica: `venv_build/Lib/site-packages/openpyxl/chart/bubble_chart.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/openpyxl/chart/bubble_chart.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 67
...
#### Clase `BubbleChart` (Línea 25)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def __init__(self, varyColors, ser, dLbls, bubble3D, bubbleScale, showNegBubbles, sizeRepresents, extLst)` (Línea 47): Sin docstring.
