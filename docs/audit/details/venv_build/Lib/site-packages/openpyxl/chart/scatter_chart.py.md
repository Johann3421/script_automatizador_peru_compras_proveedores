# Documentación Técnica: `venv_build/Lib/site-packages/openpyxl/chart/scatter_chart.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/openpyxl/chart/scatter_chart.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 53
...
#### Clase `ScatterChart` (Línea 21)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def __init__(self, scatterStyle, varyColors, ser, dLbls, extLst)` (Línea 39): Sin docstring.
