# Documentación Técnica: `venv_build/Lib/site-packages/openpyxl/workbook/external_reference.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/openpyxl/workbook/external_reference.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
...
#### Clase `ExternalReference` (Línea 11)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def __init__(self, id)` (Línea 17): Sin docstring.
