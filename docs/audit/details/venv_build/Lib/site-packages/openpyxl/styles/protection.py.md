# Documentación Técnica: `venv_build/Lib/site-packages/openpyxl/styles/protection.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/openpyxl/styles/protection.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 17
...
#### Clase `Protection` (Línea 7)
- **Docstring:** _Protection options for use in styles._
- **Métodos:**
  - `def __init__(self, locked, hidden)` (Línea 15): Sin docstring.
