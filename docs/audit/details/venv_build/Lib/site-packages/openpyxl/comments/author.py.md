# Documentación Técnica: `venv_build/Lib/site-packages/openpyxl/comments/author.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/openpyxl/comments/author.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 21
...
#### Clase `AuthorList` (Línea 11)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def __init__(self, author)` (Línea 18): Sin docstring.
