# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/building/templates.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/building/templates.py`
- **Tipo de archivo:** `.py`
