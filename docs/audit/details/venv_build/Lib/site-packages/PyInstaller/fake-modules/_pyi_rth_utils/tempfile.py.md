# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/fake-modules/_pyi_rth_utils/tempfile.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/fake-modules/_pyi_rth_utils/tempfile.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 56
