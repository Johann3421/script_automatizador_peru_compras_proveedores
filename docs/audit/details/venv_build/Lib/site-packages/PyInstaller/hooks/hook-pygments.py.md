# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pygments.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pygments.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 29
