# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-webbrowser.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-webbrowser.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 22
