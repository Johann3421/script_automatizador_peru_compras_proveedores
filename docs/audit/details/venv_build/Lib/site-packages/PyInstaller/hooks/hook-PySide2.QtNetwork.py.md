# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.QtNetwork.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.QtNetwork.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 15
