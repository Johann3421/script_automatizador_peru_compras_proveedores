# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt6.QtDesigner.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt6.QtDesigner.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
