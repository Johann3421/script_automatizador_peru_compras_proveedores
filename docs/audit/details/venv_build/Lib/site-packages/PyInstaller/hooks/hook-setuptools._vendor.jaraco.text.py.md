# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-setuptools._vendor.jaraco.text.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-setuptools._vendor.jaraco.text.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
