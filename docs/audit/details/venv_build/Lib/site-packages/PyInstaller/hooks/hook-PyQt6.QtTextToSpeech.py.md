# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt6.QtTextToSpeech.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt6.QtTextToSpeech.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
