# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.QtOpenGLFunctions.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.QtOpenGLFunctions.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
