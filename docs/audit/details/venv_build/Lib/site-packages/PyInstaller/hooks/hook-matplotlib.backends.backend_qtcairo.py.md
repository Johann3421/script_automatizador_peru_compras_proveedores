# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-matplotlib.backends.backend_qtcairo.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-matplotlib.backends.backend_qtcairo.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16
