# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-gi.repository.GstRtsp.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-gi.repository.GstRtsp.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16
