# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-importlib_metadata.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-importlib_metadata.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 24
