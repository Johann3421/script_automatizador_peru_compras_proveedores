# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-win32ctypes.core.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-win32ctypes.core.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 22
