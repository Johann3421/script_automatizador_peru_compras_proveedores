# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/pre_find_module_path/hook-tkinter.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/pre_find_module_path/hook-tkinter.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 21
...
#### `def pre_find_module_path(hook_api)` (Línea 18)
