# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-sphinx.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-sphinx.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 41
