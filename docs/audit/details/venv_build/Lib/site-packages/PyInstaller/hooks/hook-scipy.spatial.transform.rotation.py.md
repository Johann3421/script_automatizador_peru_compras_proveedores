# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-scipy.spatial.transform.rotation.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-scipy.spatial.transform.rotation.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 17
