# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pandas.io.clipboard.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pandas.io.clipboard.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 19
