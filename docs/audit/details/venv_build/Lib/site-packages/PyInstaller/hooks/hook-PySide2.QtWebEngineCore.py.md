# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.QtWebEngineCore.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.QtWebEngineCore.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 22
