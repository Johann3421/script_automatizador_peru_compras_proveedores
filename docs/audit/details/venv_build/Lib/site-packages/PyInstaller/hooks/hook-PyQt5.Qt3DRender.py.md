# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt5.Qt3DRender.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt5.Qt3DRender.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
