# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-_pyi_rth_utils.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-_pyi_rth_utils.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 17
