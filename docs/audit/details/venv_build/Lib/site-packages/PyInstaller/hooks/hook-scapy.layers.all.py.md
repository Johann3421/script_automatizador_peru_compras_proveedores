# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-scapy.layers.all.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-scapy.layers.all.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 19
