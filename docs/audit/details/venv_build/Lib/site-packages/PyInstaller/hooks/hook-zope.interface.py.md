# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-zope.interface.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-zope.interface.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 12
