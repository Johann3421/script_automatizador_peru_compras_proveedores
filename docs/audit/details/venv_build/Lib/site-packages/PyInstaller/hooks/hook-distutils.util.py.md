# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-distutils.util.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-distutils.util.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 13
