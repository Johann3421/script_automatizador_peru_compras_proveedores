# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide6.QtNetworkAuth.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide6.QtNetworkAuth.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
