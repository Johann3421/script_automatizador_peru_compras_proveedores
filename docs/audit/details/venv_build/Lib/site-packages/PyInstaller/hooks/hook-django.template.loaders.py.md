# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-django.template.loaders.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-django.template.loaders.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
