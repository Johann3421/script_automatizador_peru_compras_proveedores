# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/pre_find_module_path/hook-pyi_splash.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/pre_find_module_path/hook-pyi_splash.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 36
...
#### `def pre_find_module_path(api)` (Línea 24)
