# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-_tkinter.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-_tkinter.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 22
