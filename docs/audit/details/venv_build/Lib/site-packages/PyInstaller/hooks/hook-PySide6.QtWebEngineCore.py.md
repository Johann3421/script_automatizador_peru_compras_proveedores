# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide6.QtWebEngineCore.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide6.QtWebEngineCore.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 29
