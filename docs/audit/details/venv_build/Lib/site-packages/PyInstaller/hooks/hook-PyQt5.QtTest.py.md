# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt5.QtTest.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt5.QtTest.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
