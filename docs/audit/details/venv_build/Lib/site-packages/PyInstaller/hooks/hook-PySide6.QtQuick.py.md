# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide6.QtQuick.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide6.QtQuick.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
