# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-django.contrib.sessions.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-django.contrib.sessions.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
