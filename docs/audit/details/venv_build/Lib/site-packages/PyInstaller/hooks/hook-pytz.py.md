# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pytz.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pytz.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 20
