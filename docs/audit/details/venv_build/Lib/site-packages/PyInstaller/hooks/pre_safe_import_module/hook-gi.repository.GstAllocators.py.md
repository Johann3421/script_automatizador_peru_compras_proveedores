# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/pre_safe_import_module/hook-gi.repository.GstAllocators.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/pre_safe_import_module/hook-gi.repository.GstAllocators.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16
