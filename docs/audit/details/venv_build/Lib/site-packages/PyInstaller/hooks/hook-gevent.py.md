# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-gevent.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-gevent.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 24
