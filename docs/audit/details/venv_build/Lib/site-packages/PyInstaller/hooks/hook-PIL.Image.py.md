# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PIL.Image.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PIL.Image.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 17
