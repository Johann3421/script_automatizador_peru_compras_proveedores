# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-matplotlib.backends.backend_qtagg.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-matplotlib.backends.backend_qtagg.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16
