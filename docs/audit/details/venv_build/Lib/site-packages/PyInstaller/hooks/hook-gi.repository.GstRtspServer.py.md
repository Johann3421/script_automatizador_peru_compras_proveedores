# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-gi.repository.GstRtspServer.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-gi.repository.GstRtspServer.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16
