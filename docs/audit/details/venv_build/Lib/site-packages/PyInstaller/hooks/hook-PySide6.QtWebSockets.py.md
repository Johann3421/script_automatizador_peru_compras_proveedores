# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide6.QtWebSockets.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide6.QtWebSockets.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
