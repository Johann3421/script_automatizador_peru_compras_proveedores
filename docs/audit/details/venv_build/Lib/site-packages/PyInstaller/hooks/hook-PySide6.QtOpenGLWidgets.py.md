# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide6.QtOpenGLWidgets.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide6.QtOpenGLWidgets.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
