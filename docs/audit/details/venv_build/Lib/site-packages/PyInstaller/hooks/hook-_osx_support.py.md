# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-_osx_support.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-_osx_support.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 19
