# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-_ctypes.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-_ctypes.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 19
