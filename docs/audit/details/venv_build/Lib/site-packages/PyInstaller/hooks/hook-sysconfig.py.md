# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-sysconfig.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-sysconfig.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 29
