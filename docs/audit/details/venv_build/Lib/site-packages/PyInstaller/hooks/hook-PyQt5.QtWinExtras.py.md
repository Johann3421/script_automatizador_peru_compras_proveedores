# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt5.QtWinExtras.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt5.QtWinExtras.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
