# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/pre_safe_import_module/hook-gi.repository.GstNet.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/pre_safe_import_module/hook-gi.repository.GstNet.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16
