# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/pre_safe_import_module/hook-urllib3.packages.six.moves.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/pre_safe_import_module/hook-urllib3.packages.six.moves.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 34
...
#### `def pre_safe_import_module(api)` (Línea 18)
