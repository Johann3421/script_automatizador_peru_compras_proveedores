# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt5.QtOpenGL.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt5.QtOpenGL.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
