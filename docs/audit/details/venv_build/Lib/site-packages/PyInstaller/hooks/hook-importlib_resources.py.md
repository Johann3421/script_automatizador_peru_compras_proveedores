# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-importlib_resources.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-importlib_resources.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 22
