# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pkg_resources.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pkg_resources.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 68
