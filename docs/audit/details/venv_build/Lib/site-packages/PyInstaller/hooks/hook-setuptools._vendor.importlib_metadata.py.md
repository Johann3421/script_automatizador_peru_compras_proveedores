# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-setuptools._vendor.importlib_metadata.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-setuptools._vendor.importlib_metadata.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 21
