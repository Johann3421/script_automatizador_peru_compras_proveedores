# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PIL.ImageFilter.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PIL.ImageFilter.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 13
