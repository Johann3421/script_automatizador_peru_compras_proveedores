# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/rthooks/pyi_rth_pyside2.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/rthooks/pyi_rth_pyside2.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 63
