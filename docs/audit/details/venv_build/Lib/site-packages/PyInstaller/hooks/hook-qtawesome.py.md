# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-qtawesome.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-qtawesome.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 19
