# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-matplotlib.backends.qt_compat.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-matplotlib.backends.qt_compat.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 26
