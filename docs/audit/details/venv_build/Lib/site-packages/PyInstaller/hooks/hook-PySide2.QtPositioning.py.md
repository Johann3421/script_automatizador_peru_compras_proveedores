# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.QtPositioning.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.QtPositioning.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
