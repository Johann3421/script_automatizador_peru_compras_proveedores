# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.QtOpenGL.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.QtOpenGL.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
