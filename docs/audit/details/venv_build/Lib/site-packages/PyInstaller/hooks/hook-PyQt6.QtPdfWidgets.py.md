# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt6.QtPdfWidgets.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt6.QtPdfWidgets.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
