# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-django.core.cache.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-django.core.cache.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
