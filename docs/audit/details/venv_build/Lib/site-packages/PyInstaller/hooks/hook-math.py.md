# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-math.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-math.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 19
