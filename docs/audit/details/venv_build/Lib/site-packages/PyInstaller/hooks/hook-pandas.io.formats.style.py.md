# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pandas.io.formats.style.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pandas.io.formats.style.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
