# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/pre_safe_import_module/hook-typing_extensions.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/pre_safe_import_module/hook-typing_extensions.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 15
