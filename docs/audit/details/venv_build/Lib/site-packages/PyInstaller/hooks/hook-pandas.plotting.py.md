# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pandas.plotting.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pandas.plotting.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
