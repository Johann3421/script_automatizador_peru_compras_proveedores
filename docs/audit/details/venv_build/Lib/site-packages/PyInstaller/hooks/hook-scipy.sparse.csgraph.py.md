# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-scipy.sparse.csgraph.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-scipy.sparse.csgraph.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 13
