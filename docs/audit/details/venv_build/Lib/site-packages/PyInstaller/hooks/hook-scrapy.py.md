# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-scrapy.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-scrapy.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
