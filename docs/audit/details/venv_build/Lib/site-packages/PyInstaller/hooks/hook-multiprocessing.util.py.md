# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-multiprocessing.util.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-multiprocessing.util.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16
