# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.Qt3DLogic.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.Qt3DLogic.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
