# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-gi.repository.GtkosxApplication.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-gi.repository.GtkosxApplication.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
