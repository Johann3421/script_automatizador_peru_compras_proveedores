# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-idlelib.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-idlelib.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
