# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.QtConcurrent.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PySide2.QtConcurrent.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
