# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt5.QtNfc.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt5.QtNfc.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
