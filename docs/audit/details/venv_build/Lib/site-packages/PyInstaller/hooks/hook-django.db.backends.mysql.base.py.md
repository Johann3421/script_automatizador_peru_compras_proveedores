# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-django.db.backends.mysql.base.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-django.db.backends.mysql.base.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 13
