# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-scipy.linalg.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-scipy.linalg.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 13
