# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/rthooks/pyi_rth__tkinter.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/rthooks/pyi_rth__tkinter.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 37
