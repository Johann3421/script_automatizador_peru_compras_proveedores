# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt5.QtWebKit.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-PyQt5.QtWebKit.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
