# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pytzdata.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-pytzdata.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
