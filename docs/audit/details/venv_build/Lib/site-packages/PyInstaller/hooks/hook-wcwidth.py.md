# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/hooks/hook-wcwidth.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/hooks/hook-wcwidth.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 14
