# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/utils/cliutils/set_version.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/utils/cliutils/set_version.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 51
