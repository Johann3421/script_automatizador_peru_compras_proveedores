# Documentación Técnica: `venv_build/Lib/site-packages/PyInstaller/utils/cliutils/bindepend.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PyInstaller/utils/cliutils/bindepend.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 58
