# Documentación Técnica: `venv_build/Lib/site-packages/numpy/_core/tests/examples/limited_api/setup.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/_core/tests/examples/limited_api/setup.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 24
