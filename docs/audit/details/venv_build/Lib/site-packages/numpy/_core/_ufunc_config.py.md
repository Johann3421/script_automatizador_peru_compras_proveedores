# Documentación Técnica: `venv_build/Lib/site-packages/numpy/_core/_ufunc_config.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/_core/_ufunc_config.py`
- **Tipo de archivo:** `.py`
...
#### Clase `_unspecified` (Línea 379)
- **Docstring:** _Sin docstring._

#### Clase `errstate` (Línea 387)
- **Docstring:** _errstate(**kwargs)
...
>>> olderr = np.seterr(**olderr)  # restore original state_
- **Métodos:**
  - `def __init__(self)` (Línea 462): Sin docstring.
  - `def __enter__(self)` (Línea 472): Sin docstring.
  - `def __exit__(self)` (Línea 488): Sin docstring.
  - `def __call__(self, func)` (Línea 491): Sin docstring.

### Funciones independientes:

#### `def seterr(all, divide, over, under, invalid)` (Línea 20)
- **Propósito:** Set how floating-point errors are handled.
...
{'divide': 'print', 'over': 'print', 'under': 'print', 'invalid': 'print'}
- **Firma:** `def seterr(all, divide, over, under, invalid)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def geterr()` (Línea 112)
- **Propósito:** Get the current way of handling floating-point errors.
...
#### `def setbufsize(size)` (Línea 162)
- **Propósito:** Set the size of the buffer used in ufuncs.
...
>>> np.getbufsize()
8192
- **Firma:** `def setbufsize(size)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def getbufsize()` (Línea 208)
- **Propósito:** Return the size of the buffer used in ufuncs.
...
>>> np.getbufsize()
8192
- **Firma:** `def getbufsize()`
- **Retorno / Efectos:** Consulta código fuente.

#### `def seterrcall(func)` (Línea 234)
- **Propósito:** Set the floating-point error callback function or log object.
...
- **Firma:** `def seterrcall(func)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def geterrcall()` (Línea 329)
- **Propósito:** Return the current callback function used on floating-point errors.
