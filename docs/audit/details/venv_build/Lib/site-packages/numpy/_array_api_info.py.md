# Documentación Técnica: `venv_build/Lib/site-packages/numpy/_array_api_info.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/_array_api_info.py`
- **Tipo de archivo:** `.py`
...
#### Clase `__array_namespace_info__` (Línea 31)
- **Docstring:** _Get the array API inspection namespace for NumPy.
...
{'real floating': numpy.float64,
 ...
 'indexing': numpy.int64}_
- **Métodos:**
  - `def capabilities(self)` (Línea 63): Return a dictionary of array API library capabilities.
...
{'boolean indexing': True,
 ...
 'max dimensions': 64}
  - `def default_device(self)` (Línea 107): The default device used for new NumPy arrays.
...
>>> info.default_device()
'cpu'
  - `def default_dtypes(self)` (Línea 134): The default data types used for new NumPy arrays.
...
{'real floating': numpy.float64,
 ...
 'indexing': numpy.int64}
  - `def dtypes(self)` (Línea 186): The array API data types supported by NumPy.
...
{'int8': numpy.int8,
 ...
 'int32': numpy.int32,
 'int64': numpy.int64}
  - `def devices(self)` (Línea 321): The devices supported by NumPy.
