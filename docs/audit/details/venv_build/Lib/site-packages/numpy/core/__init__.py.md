# Documentación Técnica: `venv_build/Lib/site-packages/numpy/core/__init__.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/core/__init__.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 33
...
#### `def _ufunc_reconstruct(module, name)` (Línea 14)
- **Propósito:** Sin docstring.
- **Firma:** `def _ufunc_reconstruct(module, name)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def __getattr__(attr_name)` (Línea 30)
- **Propósito:** Sin docstring.
- **Firma:** `def __getattr__(attr_name)`
- **Retorno / Efectos:** Consulta código fuente.
