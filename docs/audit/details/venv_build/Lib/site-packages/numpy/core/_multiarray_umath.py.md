# Documentación Técnica: `venv_build/Lib/site-packages/numpy/core/_multiarray_umath.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/core/_multiarray_umath.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 57
...
#### `def __getattr__(attr_name)` (Línea 12)
