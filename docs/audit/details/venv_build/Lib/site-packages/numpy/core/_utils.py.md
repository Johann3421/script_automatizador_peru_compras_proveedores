# Documentación Técnica: `venv_build/Lib/site-packages/numpy/core/_utils.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/core/_utils.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 21
...
#### `def _raise_warning(attr, submodule)` (Línea 4)
- **Propósito:** Sin docstring.
- **Firma:** `def _raise_warning(attr, submodule)`
