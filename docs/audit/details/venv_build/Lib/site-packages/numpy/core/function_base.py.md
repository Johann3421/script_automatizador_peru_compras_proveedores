# Documentación Técnica: `venv_build/Lib/site-packages/numpy/core/function_base.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/core/function_base.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 10
...
#### `def __getattr__(attr_name)` (Línea 1)
