# Documentación Técnica: `venv_build/Lib/site-packages/numpy/exceptions.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/exceptions.py`
- **Tipo de archivo:** `.py`
...
#### Clase `ComplexWarning` (Línea 47)
- **Docstring:** _The warning raised when casting a complex dtype to a real dtype.

As implemented, casting a complex number to a real discards its imaginary
part, but this behavior may not be what the user actually wants._

#### Clase `ModuleDeprecationWarning` (Línea 58)
- **Docstring:** _Module deprecation warning.
...
nose tester will let pass without making tests fail._

#### Clase `VisibleDeprecationWarning` (Línea 75)
- **Docstring:** _Visible deprecation warning.

By default, python will not show deprecation warnings, so this class
can be used when a very visible warning is helpful, for example because
the usage is most likely a user bug._

#### Clase `RankWarning` (Línea 86)
- **Docstring:** _Matrix rank warning.

Issued by polynomial functions when the design matrix is rank deficient._

#### Clase `TooHardError` (Línea 96)
- **Docstring:** _``max_work`` was exceeded.
...
#### Clase `AxisError` (Línea 108)
- **Docstring:** _Axis supplied was invalid.
...
Custom error message_
- **Métodos:**
  - `def __init__(self, axis, ndim, msg_prefix)` (Línea 175): Sin docstring.
  - `def __str__(self)` (Línea 186): Sin docstring.

#### Clase `DTypePromotionError` (Línea 199)
- **Docstring:** _Multiple DTypes could not be converted to a common one.
