# Documentación Técnica: `venv_build/Lib/site-packages/numpy/f2py/tests/test_value_attrspec.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/f2py/tests/test_value_attrspec.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 15
...
#### Clase `TestValueAttr` (Línea 7)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_gh21665(self)` (Línea 11): Sin docstring.
