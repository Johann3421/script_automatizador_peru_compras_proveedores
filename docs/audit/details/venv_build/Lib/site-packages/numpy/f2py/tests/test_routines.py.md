# Documentación Técnica: `venv_build/Lib/site-packages/numpy/f2py/tests/test_routines.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/f2py/tests/test_routines.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 29
...
#### Clase `TestRenamedFunc` (Línea 7)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_gh25799(self)` (Línea 14): Sin docstring.

#### Clase `TestRenamedSubroutine` (Línea 20)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_renamed_subroutine(self)` (Línea 27): Sin docstring.
