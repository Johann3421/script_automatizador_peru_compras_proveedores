# Documentación Técnica: `venv_build/Lib/site-packages/numpy/f2py/tests/test_common.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/f2py/tests/test_common.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 24
...
#### Clase `TestCommonBlock` (Línea 9)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_common_block(self)` (Línea 12): Sin docstring.

#### Clase `TestCommonWithUse` (Línea 20)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_common_gh19161(self)` (Línea 23): Sin docstring.
