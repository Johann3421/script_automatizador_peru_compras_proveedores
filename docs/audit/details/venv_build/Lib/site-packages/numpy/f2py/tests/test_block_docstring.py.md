# Documentación Técnica: `venv_build/Lib/site-packages/numpy/f2py/tests/test_block_docstring.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/f2py/tests/test_block_docstring.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16
...
#### Clase `TestBlockDocString` (Línea 9)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_block_docstring(self)` (Línea 14): Sin docstring.
