# Documentación Técnica: `venv_build/Lib/site-packages/numpy/_pyinstaller/hook-numpy.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/_pyinstaller/hook-numpy.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 35
