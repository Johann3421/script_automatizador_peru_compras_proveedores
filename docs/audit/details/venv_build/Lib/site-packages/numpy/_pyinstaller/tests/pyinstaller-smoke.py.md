# Documentación Técnica: `venv_build/Lib/site-packages/numpy/_pyinstaller/tests/pyinstaller-smoke.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/_pyinstaller/tests/pyinstaller-smoke.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 32
