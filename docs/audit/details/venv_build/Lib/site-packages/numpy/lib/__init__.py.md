# Documentación Técnica: `venv_build/Lib/site-packages/numpy/lib/__init__.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/lib/__init__.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 90
