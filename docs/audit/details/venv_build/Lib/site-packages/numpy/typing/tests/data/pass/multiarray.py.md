# Documentación Técnica: `venv_build/Lib/site-packages/numpy/typing/tests/data/pass/multiarray.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/typing/tests/data/pass/multiarray.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 77
