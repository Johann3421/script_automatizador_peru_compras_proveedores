# Documentación Técnica: `venv_build/Lib/site-packages/numpy/typing/tests/data/pass/lib_version.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/typing/tests/data/pass/lib_version.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
