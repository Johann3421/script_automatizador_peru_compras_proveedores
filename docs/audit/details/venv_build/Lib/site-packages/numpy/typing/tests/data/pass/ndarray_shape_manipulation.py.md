# Documentación Técnica: `venv_build/Lib/site-packages/numpy/typing/tests/data/pass/ndarray_shape_manipulation.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/typing/tests/data/pass/ndarray_shape_manipulation.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 47
