# Documentación Técnica: `venv_build/Lib/site-packages/numpy/typing/tests/data/pass/lib_user_array.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/typing/tests/data/pass/lib_user_array.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 22
