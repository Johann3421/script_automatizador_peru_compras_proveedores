# Documentación Técnica: `venv_build/Lib/site-packages/numpy/_typing/_extended_precision.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/_typing/_extended_precision.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 15
