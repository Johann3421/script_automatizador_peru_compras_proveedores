# Documentación Técnica: `venv_build/Lib/site-packages/numpy/_typing/_char_codes.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/_typing/_char_codes.py`
- **Tipo de archivo:** `.py`
