# Documentación Técnica: `venv_build/Lib/site-packages/numpy/random/_examples/cffi/extending.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/numpy/random/_examples/cffi/extending.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 44
