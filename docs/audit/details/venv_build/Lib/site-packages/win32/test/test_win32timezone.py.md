# Documentación Técnica: `venv_build/Lib/site-packages/win32/test/test_win32timezone.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/test/test_win32timezone.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 16
...
#### Clase `Win32TimeZoneTest` (Línea 9)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def testWin32TZ(self)` (Línea 10): Sin docstring.
