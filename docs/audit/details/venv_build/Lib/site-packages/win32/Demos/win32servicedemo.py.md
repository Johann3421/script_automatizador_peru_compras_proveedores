# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/win32servicedemo.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/win32servicedemo.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 23
...
#### `def EnumServices()` (Línea 5)
- **Propósito:** Sin docstring.
- **Firma:** `def EnumServices()`
