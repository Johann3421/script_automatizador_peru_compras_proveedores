# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/SystemParametersInfo.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/SystemParametersInfo.py`
- **Tipo de archivo:** `.py`
