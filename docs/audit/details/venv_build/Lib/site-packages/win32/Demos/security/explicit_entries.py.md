# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/security/explicit_entries.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/security/explicit_entries.py`
- **Tipo de archivo:** `.py`
