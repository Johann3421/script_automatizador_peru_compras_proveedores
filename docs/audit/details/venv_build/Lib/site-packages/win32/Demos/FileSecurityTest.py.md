# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/FileSecurityTest.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/FileSecurityTest.py`
- **Tipo de archivo:** `.py`
