# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/GetSaveFileName.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/GetSaveFileName.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 43
