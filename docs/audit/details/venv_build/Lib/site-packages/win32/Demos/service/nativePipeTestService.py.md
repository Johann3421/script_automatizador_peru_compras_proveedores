# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/service/nativePipeTestService.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/service/nativePipeTestService.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 63
...
#### Clase `NativeTestPipeService` (Línea 23)
