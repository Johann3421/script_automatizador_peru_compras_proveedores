# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/EvtSubscribe_pull.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/EvtSubscribe_pull.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 28
