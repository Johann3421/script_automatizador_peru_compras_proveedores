# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/win32ts_logoff_disconnected.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/win32ts_logoff_disconnected.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 25
