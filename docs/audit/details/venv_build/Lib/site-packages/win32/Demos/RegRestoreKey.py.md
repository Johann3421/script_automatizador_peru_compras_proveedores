# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/RegRestoreKey.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/RegRestoreKey.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 71
