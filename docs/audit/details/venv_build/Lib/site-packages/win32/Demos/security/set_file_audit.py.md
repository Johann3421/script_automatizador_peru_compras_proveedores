# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/security/set_file_audit.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/security/set_file_audit.py`
- **Tipo de archivo:** `.py`
