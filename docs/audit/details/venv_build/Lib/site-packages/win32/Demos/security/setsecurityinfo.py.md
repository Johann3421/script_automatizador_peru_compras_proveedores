# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/security/setsecurityinfo.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/security/setsecurityinfo.py`
- **Tipo de archivo:** `.py`
