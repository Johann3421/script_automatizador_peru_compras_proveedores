# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/mmapfile_demo.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/mmapfile_demo.py`
- **Tipo de archivo:** `.py`
