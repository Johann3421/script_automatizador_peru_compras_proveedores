# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/security/query_information.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/security/query_information.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 25
...
#### `def GetDomainName()` (Línea 8)
- **Propósito:** Sin docstring.
- **Firma:** `def GetDomainName()`
