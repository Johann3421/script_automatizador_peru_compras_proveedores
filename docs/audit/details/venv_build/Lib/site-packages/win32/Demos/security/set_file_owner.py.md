# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/security/set_file_owner.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/security/set_file_owner.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 73
