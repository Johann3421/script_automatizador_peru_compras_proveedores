# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/security/setnamedsecurityinfo.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/security/setnamedsecurityinfo.py`
- **Tipo de archivo:** `.py`
