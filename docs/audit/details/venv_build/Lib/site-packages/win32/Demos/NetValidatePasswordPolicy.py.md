# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/NetValidatePasswordPolicy.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/NetValidatePasswordPolicy.py`
- **Tipo de archivo:** `.py`
