# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/security/lsastore.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/security/lsastore.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 12
