# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/c_extension/setup.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/c_extension/setup.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 26
