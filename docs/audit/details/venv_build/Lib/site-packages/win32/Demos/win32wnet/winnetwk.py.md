# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/win32wnet/winnetwk.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/win32wnet/winnetwk.py`
- **Tipo de archivo:** `.py`
