# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/print_desktop.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/print_desktop.py`
- **Tipo de archivo:** `.py`
