# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/security/set_policy_info.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/security/set_policy_info.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 25
