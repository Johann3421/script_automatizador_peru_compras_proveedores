# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/security/sspi/fetch_url.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/security/sspi/fetch_url.py`
- **Tipo de archivo:** `.py`
...
#### `def open_url(host, url)` (Línea 22)
- **Propósito:** Sin docstring.
- **Firma:** `def open_url(host, url)`
