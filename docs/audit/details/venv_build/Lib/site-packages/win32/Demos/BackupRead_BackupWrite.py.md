# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/BackupRead_BackupWrite.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/BackupRead_BackupWrite.py`
- **Tipo de archivo:** `.py`
