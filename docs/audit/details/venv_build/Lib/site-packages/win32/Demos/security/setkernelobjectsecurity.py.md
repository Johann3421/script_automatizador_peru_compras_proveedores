# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/security/setkernelobjectsecurity.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/security/setkernelobjectsecurity.py`
- **Tipo de archivo:** `.py`
