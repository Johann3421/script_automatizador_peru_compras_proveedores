# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/security/setuserobjectsecurity.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/security/setuserobjectsecurity.py`
- **Tipo de archivo:** `.py`
