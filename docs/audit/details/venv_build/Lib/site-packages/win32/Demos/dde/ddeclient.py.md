# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/dde/ddeclient.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/dde/ddeclient.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
