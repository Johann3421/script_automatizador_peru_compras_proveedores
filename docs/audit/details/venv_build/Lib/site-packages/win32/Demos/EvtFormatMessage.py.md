# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/EvtFormatMessage.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/EvtFormatMessage.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 83
