# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/security/GetTokenInformation.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/security/GetTokenInformation.py`
- **Tipo de archivo:** `.py`
...
#### `def dump_token(th)` (Línea 16)
- **Propósito:** Sin docstring.
- **Firma:** `def dump_token(th)`
