# Documentación Técnica: `venv_build/Lib/site-packages/win32/Demos/pipes/runproc.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/Demos/pipes/runproc.py`
- **Tipo de archivo:** `.py`
...
#### Clase `Process` (Línea 18)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def run(self, cmdline)` (Línea 19): Sin docstring.
