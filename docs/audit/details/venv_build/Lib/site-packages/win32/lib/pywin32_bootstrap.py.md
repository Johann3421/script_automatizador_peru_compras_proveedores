# Documentación Técnica: `venv_build/Lib/site-packages/win32/lib/pywin32_bootstrap.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/lib/pywin32_bootstrap.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 21
