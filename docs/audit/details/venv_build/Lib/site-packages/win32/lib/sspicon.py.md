# Documentación Técnica: `venv_build/Lib/site-packages/win32/lib/sspicon.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/lib/sspicon.py`
- **Tipo de archivo:** `.py`
...
#### `def SEC_SUCCESS(Status)` (Línea 6)
- **Propósito:** Sin docstring.
- **Firma:** `def SEC_SUCCESS(Status)`
