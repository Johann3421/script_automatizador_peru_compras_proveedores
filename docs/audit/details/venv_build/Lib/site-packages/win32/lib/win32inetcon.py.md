# Documentación Técnica: `venv_build/Lib/site-packages/win32/lib/win32inetcon.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32/lib/win32inetcon.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 1086
