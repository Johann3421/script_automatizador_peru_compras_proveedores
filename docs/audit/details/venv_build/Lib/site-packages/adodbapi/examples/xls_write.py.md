# Documentación Técnica: `venv_build/Lib/site-packages/adodbapi/examples/xls_write.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/adodbapi/examples/xls_write.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 41
