# Documentación Técnica: `venv_build/Lib/site-packages/adodbapi/examples/db_table_names.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/adodbapi/examples/db_table_names.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 21
