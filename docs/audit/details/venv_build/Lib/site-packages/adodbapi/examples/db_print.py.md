# Documentación Técnica: `venv_build/Lib/site-packages/adodbapi/examples/db_print.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/adodbapi/examples/db_print.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 72
