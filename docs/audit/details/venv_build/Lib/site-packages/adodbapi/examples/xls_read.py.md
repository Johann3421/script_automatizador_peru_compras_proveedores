# Documentación Técnica: `venv_build/Lib/site-packages/adodbapi/examples/xls_read.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/adodbapi/examples/xls_read.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 41
