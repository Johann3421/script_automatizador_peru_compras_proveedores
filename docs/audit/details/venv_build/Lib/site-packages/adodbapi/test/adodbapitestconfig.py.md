# Documentación Técnica: `venv_build/Lib/site-packages/adodbapi/test/adodbapitestconfig.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/adodbapi/test/adodbapitestconfig.py`
- **Tipo de archivo:** `.py`
