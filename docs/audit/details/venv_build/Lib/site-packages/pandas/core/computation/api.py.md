# Documentación Técnica: `venv_build/Lib/site-packages/pandas/core/computation/api.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/core/computation/api.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 2
