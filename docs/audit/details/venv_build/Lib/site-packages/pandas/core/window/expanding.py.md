# Documentación Técnica: `venv_build/Lib/site-packages/pandas/core/window/expanding.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/core/window/expanding.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 1412
...
#### Clase `Expanding` (Línea 43)
- **Docstring:** _Provide expanding window calculations.
...
4  7.0_
- **Métodos:**
  - `def __init__(self, obj, min_periods, method, selection)` (Línea 112): Sin docstring.
  - `def _get_window_indexer(self)` (Línea 126): Return an indexer class that will compute the window start and end bounds
  - `def aggregate(self, func)` (Línea 132): Aggregate using one or more operations over the specified axis.
...
1  3.0  4.0
2  6.0  4.0
  - `def count(self, numeric_only)` (Línea 214): Calculate the expanding count of non NaN observations.
...
d    4.0
dtype: float64
  - `def apply(self, func, raw, engine, engine_kwargs, args, kwargs)` (Línea 247): Calculate the expanding custom aggregation function.
...
d    2.0
dtype: float64
  - `def pipe(self, func)` (Línea 327): Sin docstring.
  - `def pipe(self, func)` (Línea 335): Sin docstring.
  - `def pipe(self, func)` (Línea 343): Apply a ``func`` with arguments to this Expanding object and return its result.
...
2012-08-04  2.0
2012-08-05  3.0
  - `def sum(self, numeric_only, engine, engine_kwargs)` (Línea 428): Calculate the expanding sum.
...
d    10.0
dtype: float64
  - `def max(self, numeric_only, engine, engine_kwargs)` (Línea 488): Calculate the expanding maximum.
...
d    4.0
dtype: float64
  - `def min(self, numeric_only, engine, engine_kwargs)` (Línea 548): Calculate the expanding minimum.
...
d    1.0
dtype: float64
  - `def mean(self, numeric_only, engine, engine_kwargs)` (Línea 608): Calculate the expanding mean.
...
d    2.5
dtype: float64
  - `def median(self, numeric_only, engine, engine_kwargs)` (Línea 668): Calculate the expanding median.
...
d    2.5
dtype: float64
  - `def std(self, ddof, numeric_only, engine, engine_kwargs)` (Línea 728): Calculate the expanding standard deviation.
...
6    0.786796
dtype: float64
  - `def var(self, ddof, numeric_only, engine, engine_kwargs)` (Línea 801): Calculate the expanding variance.
...
6    0.619048
dtype: float64
  - `def sem(self, ddof, numeric_only)` (Línea 874): Calculate the expanding standard error of mean.
...
3    0.645497
dtype: float64
  - `def skew(self, numeric_only)` (Línea 916): Calculate the expanding unbiased skewness.
...
e    0.315356
dtype: float64
  - `def kurt(self, numeric_only)` (Línea 955): Calculate the expanding Fisher's definition of kurtosis without bias.
...
4    4.999874
dtype: float64
  - `def first(self, numeric_only)` (Línea 1003): Calculate the expanding First (left-most) element of the window.
...
4         0.0
dtype: float64
  - `def last(self, numeric_only)` (Línea 1038): Calculate the expanding Last (right-most) element of the window.
...
4         4.0
dtype: float64
  - `def quantile(self, q, interpolation, numeric_only)` (Línea 1073): Calculate the expanding quantile.
...
f    2.25
dtype: float64
  - `def rank(self, method, ascending, pct, numeric_only)` (Línea 1131): Calculate the expanding rank.
...
5    3.0
dtype: float64
  - `def nunique(self, numeric_only)` (Línea 1207): Calculate the expanding nunique.
...
5    5.0
dtype: float64
  - `def cov(self, other, pairwise, ddof, numeric_only)` (Línea 1249): Calculate the expanding sample covariance.
...
d    3.333333
dtype: float64
  - `def corr(self, other, pairwise, ddof, numeric_only)` (Línea 1307): Calculate the expanding correlation.
...
#### Clase `ExpandingGroupby` (Línea 1393)
- **Docstring:** _Provide an expanding groupby implementation._
- **Métodos:**
  - `def _get_window_indexer(self)` (Línea 1400): Return an indexer class that will compute the window start and end bounds
