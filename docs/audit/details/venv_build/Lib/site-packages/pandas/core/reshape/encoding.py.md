# Documentación Técnica: `venv_build/Lib/site-packages/pandas/core/reshape/encoding.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/core/reshape/encoding.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 589
...
#### `def get_dummies(data, prefix, prefix_sep, dummy_na, columns, sparse, drop_first, dtype)` (Línea 43)
- **Propósito:** Convert categorical variable into dummy/indicator variables.
...
1  0.0  1.0  0.0
2  0.0  0.0  1.0
- **Firma:** `def get_dummies(data, prefix, prefix_sep, dummy_na, columns, sparse, drop_first, dtype)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def _get_dummies_1d(data, prefix, prefix_sep, dummy_na, sparse, drop_first, dtype)` (Línea 242)
- **Propósito:** Sin docstring.
- **Firma:** `def _get_dummies_1d(data, prefix, prefix_sep, dummy_na, sparse, drop_first, dtype)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def from_dummies(data, sep, default_category)` (Línea 372)
- **Propósito:** Create a categorical ``DataFrame`` from a ``DataFrame`` of dummy variables.
...
1    b       a
2    d       e
- **Firma:** `def from_dummies(data, sep, default_category)`
- **Retorno / Efectos:** Consulta código fuente.
