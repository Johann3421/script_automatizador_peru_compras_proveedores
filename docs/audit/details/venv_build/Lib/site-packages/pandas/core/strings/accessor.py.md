# Documentación Técnica: `venv_build/Lib/site-packages/pandas/core/strings/accessor.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/core/strings/accessor.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 4882
...
#### Clase `StringMethods` (Línea 150)
- **Docstring:** _Vectorized string functions for Series and Index.
...
dtype: str_
- **Métodos:**
  - `def __init__(self, data)` (Línea 191): Sin docstring.
  - `def _validate(data)` (Línea 211): Auxiliary function for StringMethods, infers and checks dtype of data.
...
dtype : inferred dtype of data
  - `def __getitem__(self, key)` (Línea 253): Sin docstring.
  - `def __iter__(self)` (Línea 257): Sin docstring.
  - `def _wrap_result(self, result, name, expand, fill_value, returns_string, dtype)` (Línea 260): Sin docstring.
  - `def _get_series_list(self, others)` (Línea 404): Auxiliary function for :meth:`str.cat`. Turn potentially mixed input
...
list of Series
  ...
  - `def cat(self, others, sep, na_rep, join)` (Línea 469): Concatenate strings in the Series/Index with given separator.
...
For more examples, see :ref:`here <text.concatenate>`.
  - `def split(self, pat)` (Línea 701): Split strings around given separator/delimiter.
...
>>> s.str.split(r"\.jpg", regex=False, expand=True)
               0
0  foojpgbar.jpg
  - `def rsplit(self, pat)` (Línea 902): Split strings around given separator/delimiter.
...
1  https://docs.python.org/3/tutorial  index.html
2                                 NaN         NaN
  - `def partition(self, sep, expand)` (Línea 1031): Split the string at the first occurrence of `sep`.
...
Index([('X', ' ', '123'), ('Y', ' ', '999')], dtype='object')
  - `def rpartition(self, sep, expand)` (Línea 1123): Split the string at the last occurrence of `sep`.
...
>>> idx.str.partition(expand=False)
Index([('X', ' ', '123'), ('Y', ' ', '999')], dtype='object')
  - `def get(self, i)` (Línea 1214): Extract element from each component at specified position or with specified key.
...
1    Goodbye
dtype: object
  - `def join(self, sep)` (Línea 1293): Join lists contained as elements in the Series/Index with passed delimiter.
...
4                    NaN
dtype: object
  - `def contains(self, pat, case, flags, na, regex)` (Línea 1363): Test if pattern or regex is contained within a string of a Series or Index.
...
4    False
dtype: bool
  - `def match(self, pat, case, flags, na)` (Línea 1500): Determine if each string starts with a match of a regular expression.
...
2   False
dtype: bool
  - `def fullmatch(self, pat, case, flags, na)` (Línea 1589): Determine if each string entirely matches a regular expression.
...
2    True
dtype: bool
  - `def replace(self, pat, repl, n, case, flags, regex)` (Línea 1638): Replace each occurrence of pattern/regex in the Series/Index.
...
2    NaN
dtype: str
  - `def repeat(self, repeats)` (Línea 1822): Duplicate each string in the Series or Index.
...
2    ccc
dtype: str
  - `def pad(self, width, side, fillchar)` (Línea 1884): Pad strings in the Series/Index up to width.
...
1    --tiger---
dtype: str
  - `def center(self, width, fillchar)` (Línea 1963): Pad left and right side of strings in the Series/Index.
...
2   ...mouse
dtype: str
  - `def ljust(self, width, fillchar)` (Línea 2025): Pad right side of strings in the Series/Index.
...
2   ...mouse
dtype: str
  - `def rjust(self, width, fillchar)` (Línea 2087): Pad left side of strings in the Series/Index.
...
2   ...mouse
dtype: str
  - `def zfill(self, width)` (Línea 2149): Pad strings in the Series/Index by prepending '0' characters.
...
4     NaN
dtype: object
  - `def slice(self, start, stop, step)` (Línea 2217): Slice substrings from each element in the Series or Index.
...
2    cm
dtype: str
  - `def slice_replace(self, start, stop, repl)` (Línea 2298): Replace a positional slice of a string with another value.
...
4    aXde
dtype: str
  - `def decode(self, encoding, errors, dtype)` (Línea 2378): Decode character string in the Series/Index using indicated encoding.
...
2   ()
dtype: str
  - `def encode(self, encoding, errors)` (Línea 2437): Encode character string in the Series/Index using indicated encoding.
...
2      b'()'
dtype: object
  - `def strip(self, to_strip)` (Línea 2473): Remove leading and trailing characters.
...
5    NaN
dtype: object
  - `def lstrip(self, to_strip)` (Línea 2553): Remove leading characters.
...
5    NaN
dtype: object
  - `def rstrip(self, to_strip)` (Línea 2632): Remove trailing characters.
...
5    NaN
dtype: object
  - `def removeprefix(self, prefix)` (Línea 2711): Remove a prefix from an object series.
...
2    no_suffix
dtype: str
  - `def removesuffix(self, suffix)` (Línea 2761): Remove a suffix from an object series.
...
2    no_suffix
dtype: str
  - `def wrap(self, width, expand_tabs, tabsize, replace_whitespace, drop_whitespace, initial_indent, subsequent_indent, fix_sentence_endings, break_long_words, break_on_hyphens, max_lines, placeholder)` (Línea 2811): Wrap strings in Series/Index at specified line width.
...
1    another line\nto be\nwrapped
dtype: str
  - `def get_dummies(self, sep, dtype)` (Línea 2936): Return DataFrame of dummy/indicator variables for Series.
...
1   False  False   False
2   True   False   True
  - `def translate(self, table)` (Línea 3005): Map all characters in the string through the given mapping table.
...
1   Francoise
dtype: str
  - `def count(self, pat, flags)` (Línea 3049): Count occurrences of pattern in each string of the Series/Index.
...
Index([0, 0, 2, 1], dtype='int64')
  - `def startswith(self, pat, na)` (Línea 3115): Test if the start of each string element matches a pattern.
...
3    False
dtype: bool
  - `def endswith(self, pat, na)` (Línea 3177): Test if the end of each string element matches a pattern.
...
3    False
dtype: bool
  - `def findall(self, pat, flags)` (Línea 3239): Find all occurrences of pattern or regular expression in the Series/Index.
...
2    [b, b]
dtype: object
  - `def extract(self, pat, flags, expand)` (Línea 3332): Extract capture groups in the regex `pat` as columns in a DataFrame.
...
2    NaN
dtype: str
  - `def extractall(self, pat, flags)` (Línea 3460): Extract capture groups in the regex `pat` as columns in DataFrame.
...
B 0          b     1
C 0        NaN     1
  - `def find(self, sub, start, end)` (Línea 3538): Return lowest indexes in each strings in the Series/Index.
...
2   4
dtype: int64
  - `def rfind(self, sub, start, end)` (Línea 3594): Return highest indexes in each strings in the Series/Index.
...
2   4
dtype: int64
  - `def normalize(self, form)` (Línea 3650): Return the Unicode normal form for the strings in the Series/Index.
...
0   False
dtype: bool
  - `def index(self, sub, start, end)` (Línea 3690): Return lowest indexes in each string in Series/Index.
...
2   3
dtype: int64
  - `def rindex(self, sub, start, end)` (Línea 3747): Return highest indexes in each string in Series/Index.
...
2   3
dtype: int64
  - `def len(self)` (Línea 3803): Compute the length of each element in the Series/Index.
...
5    3.0
dtype: float64
  - `def lower(self)` (Línea 3850): Convert strings in the Series/Index to lowercase.
...
3              sWaPcAsE
dtype: str
  - `def upper(self)` (Línea 3922): Convert strings in the Series/Index to uppercase.
...
3              sWaPcAsE
dtype: str
  - `def title(self)` (Línea 3994): Convert strings in the Series/Index to titlecase.
...
3              sWaPcAsE
dtype: str
  - `def capitalize(self)` (Línea 4066): Convert strings in the Series/Index to be capitalized.
...
3              sWaPcAsE
dtype: str
  - `def swapcase(self)` (Línea 4138): Convert strings in the Series/Index to be swapcased.
...
3              sWaPcAsE
dtype: str
  - `def casefold(self)` (Línea 4210): Convert strings in the Series/Index to be casefolded.
...
3              sWaPcAsE
dtype: str
  - `def isalnum(self)` (Línea 4282): Check whether all characters in each string are alphanumeric.
...
2    False
dtype: bool
  - `def isalpha(self)` (Línea 4332): Check whether all characters in each string are alphabetic.
...
3    False
dtype: bool
  - `def isdigit(self)` (Línea 4373): Check whether all characters in each string are digits.
...
3    False
dtype: bool
  - `def isspace(self)` (Línea 4426): Check whether all characters in each string are whitespace.
...
2    False
dtype: bool
  - `def islower(self)` (Línea 4466): Check whether all characters in each string are lowercase.
...
3    False
dtype: bool
  - `def isascii(self)` (Línea 4507): Check whether all characters in each string are ascii.
...
3     True
dtype: bool
  - `def isupper(self)` (Línea 4551): Check whether all characters in each string are uppercase.
...
3    False
dtype: bool
  - `def istitle(self)` (Línea 4592): Check whether all characters in each string are titlecase.
...
3    False
dtype: bool
  - `def isnumeric(self)` (Línea 4637): Check whether all characters in each string are numeric.
...
2    False
dtype: bool
  - `def isdecimal(self)` (Línea 4698): Check whether all characters in each string are decimal.
...
#### `def forbid_nonstring_types(forbidden, name)` (Línea 81)
- **Propósito:** Decorator to forbid specific types for a method of StringMethods.
...
- **Firma:** `def forbid_nonstring_types(forbidden, name)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def cat_safe(list_of_columns, sep)` (Línea 4741)
- **Propósito:** Auxiliary function for :meth:`str.cat`.
...
- **Firma:** `def cat_safe(list_of_columns, sep)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def cat_core(list_of_columns, sep)` (Línea 4777)
- **Propósito:** Auxiliary function for :meth:`str.cat`
...
nd.array
    The concatenation of list_of_columns with sep.
- **Firma:** `def cat_core(list_of_columns, sep)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def _result_dtype(arr)` (Línea 4804)
- **Propósito:** Sin docstring.
- **Firma:** `def _result_dtype(arr)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def _get_single_group_name(regex)` (Línea 4815)
- **Propósito:** Sin docstring.
- **Firma:** `def _get_single_group_name(regex)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def _get_group_names(regex)` (Línea 4822)
- **Propósito:** Get named groups from compiled regex.
...
- **Firma:** `def _get_group_names(regex)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def str_extractall(arr, pat, flags)` (Línea 4847)
- **Propósito:** Sin docstring.
- **Firma:** `def str_extractall(arr, pat, flags)`
- **Retorno / Efectos:** Consulta código fuente.
