# Documentación Técnica: `venv_build/Lib/site-packages/pandas/core/dtypes/inference.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/core/dtypes/inference.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 518
...
#### `def is_number(obj)` (Línea 40)
- **Propósito:** Check if the object is a number.
...
>>> is_number("5")
False
- **Firma:** `def is_number(obj)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def iterable_not_string(obj)` (Línea 81)
- **Propósito:** Check if the object is an iterable but not a string.
...
False
- **Firma:** `def iterable_not_string(obj)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def is_file_like(obj)` (Línea 107)
- **Propósito:** Check if the object is a file-like object.
...
>>> is_file_like([1, 2, 3])
False
- **Firma:** `def is_file_like(obj)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def is_re(obj)` (Línea 155)
- **Propósito:** Check if the object is a regex pattern instance.
...
#### `def is_re_compilable(obj)` (Línea 192)
- **Propósito:** Check if the object can be compiled into a regex pattern instance.
...
>>> is_re_compilable(1)
False
- **Firma:** `def is_re_compilable(obj)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def is_array_like(obj)` (Línea 227)
- **Propósito:** Check if the object is array-like.
...
>>> is_array_like(("a", "b"))
False
- **Firma:** `def is_array_like(obj)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def is_nested_list_like(obj)` (Línea 259)
- **Propósito:** Check if the object is list-like, and that all of its elements
are also list-like.
...
--------
is_list_like
- **Firma:** `def is_nested_list_like(obj)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def is_dict_like(obj)` (Línea 307)
- **Propósito:** Check if the object is dict-like.
...
>>> is_dict_like(dict())
True
- **Firma:** `def is_dict_like(obj)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def is_named_tuple(obj)` (Línea 350)
- **Propósito:** Check if the object is a named tuple.
...
>>> is_named_tuple((1, 2))
False
- **Firma:** `def is_named_tuple(obj)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def is_hashable(obj, allow_slice)` (Línea 388)
- **Propósito:** Return True if hash(obj) will succeed, False otherwise.
...
>>> is_hashable(a)
False
- **Firma:** `def is_hashable(obj, allow_slice)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def is_sequence(obj)` (Línea 452)
- **Propósito:** Check if the object is a sequence of objects.
...
>>> is_sequence(iter(l))
False
- **Firma:** `def is_sequence(obj)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def is_dataclass(item)` (Línea 485)
- **Propósito:** Checks if the object is a data-class instance
