# Documentación Técnica: `venv_build/Lib/site-packages/pandas/core/groupby/base.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/core/groupby/base.py`
- **Tipo de archivo:** `.py`
