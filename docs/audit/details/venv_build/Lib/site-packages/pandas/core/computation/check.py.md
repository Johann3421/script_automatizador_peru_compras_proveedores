# Documentación Técnica: `venv_build/Lib/site-packages/pandas/core/computation/check.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/core/computation/check.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 8
