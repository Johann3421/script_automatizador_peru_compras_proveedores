# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/construction/test_extract_array.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/construction/test_extract_array.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 18
...
#### `def test_extract_array_rangeindex()` (Línea 6)
- **Propósito:** Sin docstring.
- **Firma:** `def test_extract_array_rangeindex()`
