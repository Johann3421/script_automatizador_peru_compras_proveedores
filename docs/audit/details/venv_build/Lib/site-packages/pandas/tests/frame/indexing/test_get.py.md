# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/frame/indexing/test_get.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/frame/indexing/test_get.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 27
...
#### Clase `TestGet` (Línea 7)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_get(self, float_frame)` (Línea 8): Sin docstring.
  - `def test_get_none(self, columns, index)` (Línea 25): Sin docstring.
