# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/series/methods/test_dtypes.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/series/methods/test_dtypes.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 7
...
#### Clase `TestSeriesDtypes` (Línea 4)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_dtype(self, datetime_series)` (Línea 5): Sin docstring.
