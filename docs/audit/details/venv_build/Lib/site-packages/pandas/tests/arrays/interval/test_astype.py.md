# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/arrays/interval/test_astype.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/arrays/interval/test_astype.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 28
...
#### Clase `TestAstype` (Línea 12)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_astype_categorical_retains_ordered(self, ordered)` (Línea 14): Sin docstring.
