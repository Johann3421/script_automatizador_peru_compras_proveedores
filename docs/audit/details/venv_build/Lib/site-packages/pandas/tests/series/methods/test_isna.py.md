# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/series/methods/test_isna.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/series/methods/test_isna.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 36
...
#### Clase `TestIsna` (Línea 14)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_isna_period_dtype(self)` (Línea 15): Sin docstring.
  - `def test_isna(self)` (Línea 27): Sin docstring.
