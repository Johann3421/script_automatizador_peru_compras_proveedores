# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/arrays/floating/test_contains.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/arrays/floating/test_contains.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 15
...
#### `def test_contains_nan(using_nan_is_na)` (Línea 6)
- **Propósito:** Sin docstring.
- **Firma:** `def test_contains_nan(using_nan_is_na)`
