# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/series/methods/test_get_numeric_data.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/series/methods/test_get_numeric_data.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 31
...
#### Clase `TestGetNumericData` (Línea 8)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_get_numeric_data_preserve_dtype(self)` (Línea 9): Sin docstring.
