# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/extension/array_with_attr/__init__.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/extension/array_with_attr/__init__.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 6
