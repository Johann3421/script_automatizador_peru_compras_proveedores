# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/indexes/datetimelike_/test_indexing.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/indexes/datetimelike_/test_indexing.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 45
...
#### `def test_get_indexer_non_unique_wrong_dtype(ldtype, rdtype)` (Línea 21)
- **Propósito:** Sin docstring.
- **Firma:** `def test_get_indexer_non_unique_wrong_dtype(ldtype, rdtype)`
