# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/frame/methods/test_droplevel.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/frame/methods/test_droplevel.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 36
...
#### Clase `TestDropLevel` (Línea 11)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_droplevel(self, frame_or_series)` (Línea 12): Sin docstring.
