# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/arithmetic/test_bool.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/arithmetic/test_bool.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 28
...
#### `def test_divmod_bool_raises(box_with_array)` (Línea 10)
- **Propósito:** Sin docstring.
- **Firma:** `def test_divmod_bool_raises(box_with_array)`
