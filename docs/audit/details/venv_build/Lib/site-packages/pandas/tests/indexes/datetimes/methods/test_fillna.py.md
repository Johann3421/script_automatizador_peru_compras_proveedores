# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/indexes/datetimes/methods/test_fillna.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/indexes/datetimes/methods/test_fillna.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 62
...
#### Clase `TestDatetimeIndexFillNA` (Línea 7)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_fillna_datetime64(self, tz)` (Línea 9): Sin docstring.
