# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/series/methods/test_size.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/series/methods/test_size.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 20
...
#### `def test_series(data, index, expected)` (Línea 16)
- **Propósito:** Sin docstring.
- **Firma:** `def test_series(data, index, expected)`
