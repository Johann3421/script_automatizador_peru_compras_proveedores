# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/series/methods/test_matmul.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/series/methods/test_matmul.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 82
...
#### Clase `TestMatmul` (Línea 13)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_matmul(self)` (Línea 14): Sin docstring.
