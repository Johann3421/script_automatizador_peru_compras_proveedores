# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/indexes/base_class/test_where.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/indexes/base_class/test_where.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 13
...
#### Clase `TestWhere` (Línea 7)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_where_intlike_str_doesnt_cast_ints(self)` (Línea 8): Sin docstring.
