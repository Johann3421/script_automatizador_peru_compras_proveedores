# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/series/methods/test_count.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/series/methods/test_count.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 24
...
#### Clase `TestSeriesCount` (Línea 9)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_count(self, datetime_series)` (Línea 10): Sin docstring.
  - `def test_count_categorical(self)` (Línea 17): Sin docstring.
