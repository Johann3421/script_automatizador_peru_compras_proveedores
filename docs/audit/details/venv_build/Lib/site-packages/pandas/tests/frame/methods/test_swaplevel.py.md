# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/frame/methods/test_swaplevel.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/frame/methods/test_swaplevel.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 36
...
#### Clase `TestSwaplevel` (Línea 7)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def test_swaplevel(self, multiindex_dataframe_random_data)` (Línea 8): Sin docstring.
