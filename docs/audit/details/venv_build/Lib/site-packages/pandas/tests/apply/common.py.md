# Documentación Técnica: `venv_build/Lib/site-packages/pandas/tests/apply/common.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/tests/apply/common.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 7
