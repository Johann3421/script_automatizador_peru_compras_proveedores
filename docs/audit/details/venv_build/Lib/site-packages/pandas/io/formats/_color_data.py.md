# Documentación Técnica: `venv_build/Lib/site-packages/pandas/io/formats/_color_data.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/io/formats/_color_data.py`
- **Tipo de archivo:** `.py`
