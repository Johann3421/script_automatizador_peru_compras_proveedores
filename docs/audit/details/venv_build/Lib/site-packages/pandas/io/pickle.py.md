# Documentación Técnica: `venv_build/Lib/site-packages/pandas/io/pickle.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/io/pickle.py`
- **Tipo de archivo:** `.py`
...
#### `def to_pickle(obj, filepath_or_buffer, compression, protocol, storage_options)` (Línea 33)
- **Propósito:** Pickle (serialize) object to file.
...
3    3    8
4    4    9
- **Firma:** `def to_pickle(obj, filepath_or_buffer, compression, protocol, storage_options)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def read_pickle(filepath_or_buffer, compression, storage_options)` (Línea 131)
- **Propósito:** Load pickled pandas object (or any object) from file and return unpickled object.
...
3    3    8
4    4    9
- **Firma:** `def read_pickle(filepath_or_buffer, compression, storage_options)`
- **Retorno / Efectos:** Consulta código fuente.
