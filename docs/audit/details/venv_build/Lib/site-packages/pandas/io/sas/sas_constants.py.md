# Documentación Técnica: `venv_build/Lib/site-packages/pandas/io/sas/sas_constants.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/io/sas/sas_constants.py`
- **Tipo de archivo:** `.py`
