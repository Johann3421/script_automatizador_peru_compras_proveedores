# Documentación Técnica: `venv_build/Lib/site-packages/pandas/plotting/_core.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/pandas/plotting/_core.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 2255
- **Fecha de inspección:** 2026-08-05 18:36:18
...
#### Clase `PlotAccessor` (Línea 773)
- **Docstring:** _Make plots of Series or DataFrame.
...
.. plot::
    ...
    >>> plot = df.groupby("col2").plot(kind="bar", title="DataFrameGroupBy Plot")_
- **Métodos:**
  - `def __init__(self, data)` (Línea 995): Sin docstring.
  - `def _get_call_args(backend_name, data, args, kwargs)` (Línea 999): This function makes calls to this accessor `__call__` method compatible
...
parameters.
  - `def __call__(self)` (Línea 1104): Sin docstring.
  - `def line(self, x, y, color)` (Línea 1189): Plot Series or DataFrame as lines.
...
.. plot::
  ...
  - `def bar(self, x, y, color)` (Línea 1297): Vertical bar plot.
...
.. plot::
  ...
  - `def barh(self, x, y, color)` (Línea 1434): Make a horizontal bar plot.
...
.. plot::
  ...
  - `def box(self, by)` (Línea 1577): Make a box plot of the DataFrame columns.
...
.. plot::
  ...
  - `def hist(self, by, bins)` (Línea 1639): Draw one histogram of the DataFrame's columns.
...
.. plot::
  ...
  - `def kde(self, bw_method, ind, weights)` (Línea 1696): Generate Kernel Density Estimate plot using Gaussian kernels.
...
.. plot::
  ...
  - `def area(self, x, y, stacked)` (Línea 1818): Draw a stacked area plot.
...
.. plot::
  ...
  - `def pie(self, y)` (Línea 1903): Generate a pie plot.
...
.. plot::
  ...
  - `def scatter(self, x, y, s, c)` (Línea 1961): Create a scatter plot with varying marker point size and color.
...
.. plot::
    ...
    ... )
  - `def hexbin(self, x, y, C, reduce_C_function, gridsize)` (Línea 2056): Generate a hexagonal binning plot.
...
#### `def holds_integer(column)` (Línea 45)
- **Propósito:** Sin docstring.
- **Firma:** `def holds_integer(column)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def hist_series(self, by, ax, grid, xlabelsize, xrot, ylabelsize, yrot, figsize, bins, backend, legend)` (Línea 50)
- **Propósito:** Draw histogram of the input series using matplotlib.
...
- **Firma:** `def hist_series(self, by, ax, grid, xlabelsize, xrot, ylabelsize, yrot, figsize, bins, backend, legend)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def hist_frame(data, column, by, grid, xlabelsize, xrot, ylabelsize, yrot, ax, sharex, sharey, figsize, layout, bins, backend, legend)` (Línea 149)
- **Propósito:** Make a histogram of the DataFrame's columns.
...
.. plot::
    ...
    >>> hist = df.hist(bins=3)
- **Firma:** `def hist_frame(data, column, by, grid, xlabelsize, xrot, ylabelsize, yrot, ax, sharex, sharey, figsize, layout, bins, backend, legend)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def boxplot(data, column, by, ax, fontsize, rot, grid, figsize, layout, return_type)` (Línea 279)
- **Propósito:** Make a box plot from DataFrame columns.
...
as ``layout`` is returned:
    ...
    >>> type(boxplot)
    <class 'numpy.ndarray'>
- **Firma:** `def boxplot(data, column, by, ax, fontsize, rot, grid, figsize, layout, return_type)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def boxplot_frame(self, column, by, ax, fontsize, rot, grid, figsize, layout, return_type, backend)` (Línea 467)
- **Propósito:** Make a box plot from DataFrame columns.
...
.. plot::
    ...
    >>> type(boxplot)
    <class 'numpy.ndarray'>
- **Firma:** `def boxplot_frame(self, column, by, ax, fontsize, rot, grid, figsize, layout, return_type, backend)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def boxplot_frame_groupby(grouped, subplots, column, fontsize, rot, grid, ax, figsize, layout, sharex, sharey, backend)` (Línea 669)
- **Propósito:** Make box plots from DataFrameGroupBy data.
...
- **Firma:** `def boxplot_frame_groupby(grouped, subplots, column, fontsize, rot, grid, ax, figsize, layout, sharex, sharey, backend)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def _load_backend(backend)` (Línea 2160)
- **Propósito:** Load a pandas plotting backend.
...
- **Firma:** `def _load_backend(backend)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def _get_plot_backend(backend)` (Línea 2229)
- **Propósito:** Return the plotting backend to use (e.g. `pandas.plotting._matplotlib`).
...
- **Firma:** `def _get_plot_backend(backend)`
- **Retorno / Efectos:** Consulta código fuente.
