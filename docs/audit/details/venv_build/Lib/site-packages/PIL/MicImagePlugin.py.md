# Documentación Técnica: `venv_build/Lib/site-packages/PIL/MicImagePlugin.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PIL/MicImagePlugin.py`
- **Tipo de archivo:** `.py`
...
#### Clase `MicImageFile` (Línea 36)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def _open(self)` (Línea 41): Sin docstring.
  - `def seek(self, frame)` (Línea 74): Sin docstring.
  - `def tell(self)` (Línea 84): Sin docstring.
  - `def close(self)` (Línea 87): Sin docstring.
  - `def __exit__(self)` (Línea 92): Sin docstring.

### Funciones independientes:

#### `def _accept(prefix)` (Línea 28)
