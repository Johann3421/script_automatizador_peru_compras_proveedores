# Documentación Técnica: `venv_build/Lib/site-packages/PIL/FtexImagePlugin.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PIL/FtexImagePlugin.py`
- **Tipo de archivo:** `.py`
...
#### Clase `Format` (Línea 65)
- **Docstring:** _Sin docstring._

#### Clase `FtexImageFile` (Línea 70)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def _open(self)` (Línea 74): Sin docstring.
  - `def load_seek(self, pos)` (Línea 106): Sin docstring.

### Funciones independientes:

#### `def _accept(prefix)` (Línea 110)
