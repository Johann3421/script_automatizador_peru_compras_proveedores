# Documentación Técnica: `venv_build/Lib/site-packages/PIL/_typing.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/PIL/_typing.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 45
...
#### Clase `SupportsRead` (Línea 38)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def read()` (Línea 39): Sin docstring.
