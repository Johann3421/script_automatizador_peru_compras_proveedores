# Documentación Técnica: `venv_build/Lib/site-packages/win32comext/bits/test/show_all_jobs.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32comext/bits/test/show_all_jobs.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 48
