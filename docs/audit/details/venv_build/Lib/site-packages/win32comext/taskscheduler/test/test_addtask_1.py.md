# Documentación Técnica: `venv_build/Lib/site-packages/win32comext/taskscheduler/test/test_addtask_1.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32comext/taskscheduler/test/test_addtask_1.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 68
