# Documentación Técnica: `venv_build/Lib/site-packages/win32comext/axdebug/dump.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32comext/axdebug/dump.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 57
...
#### `def DumpDebugApplicationNode(node, level)` (Línea 8)
- **Propósito:** Sin docstring.
- **Firma:** `def DumpDebugApplicationNode(node, level)`
- **Retorno / Efectos:** Consulta código fuente.

#### `def dumpall()` (Línea 39)
- **Propósito:** Sin docstring.
- **Firma:** `def dumpall()`
- **Retorno / Efectos:** Consulta código fuente.
