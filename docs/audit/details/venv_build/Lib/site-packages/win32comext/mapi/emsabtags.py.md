# Documentación Técnica: `venv_build/Lib/site-packages/win32comext/mapi/emsabtags.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32comext/mapi/emsabtags.py`
- **Tipo de archivo:** `.py`
