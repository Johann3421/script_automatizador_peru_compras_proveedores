# Documentación Técnica: `venv_build/Lib/site-packages/win32comext/internet/inetcon.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32comext/internet/inetcon.py`
- **Tipo de archivo:** `.py`
