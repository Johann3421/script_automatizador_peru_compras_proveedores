# Documentación Técnica: `venv_build/Lib/site-packages/win32comext/ifilter/ifiltercon.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32comext/ifilter/ifiltercon.py`
- **Tipo de archivo:** `.py`
