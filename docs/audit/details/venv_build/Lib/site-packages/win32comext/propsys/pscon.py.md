# Documentación Técnica: `venv_build/Lib/site-packages/win32comext/propsys/pscon.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32comext/propsys/pscon.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 839
