# Documentación Técnica: `venv_build/Lib/site-packages/win32comext/axscript/asputil.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32comext/axscript/asputil.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 13
...
#### `def iif(cond, t, f)` (Línea 9)
- **Propósito:** Sin docstring.
- **Firma:** `def iif(cond, t, f)`
