# Documentación Técnica: `venv_build/Lib/site-packages/win32comext/axscript/client/pyscript_rexec.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32comext/axscript/client/pyscript_rexec.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 54
...
#### Clase `PyScriptRExec` (Línea 21)
- **Docstring:** _Sin docstring._
- **Métodos:**
  - `def _GetSupportedInterfaceSafetyOptions(self)` (Línea 33): Sin docstring.
