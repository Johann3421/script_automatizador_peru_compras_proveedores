# Documentación Técnica: `venv_build/Lib/site-packages/win32comext/shell/demos/IShellLinkDataList.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32comext/shell/demos/IShellLinkDataList.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 67
