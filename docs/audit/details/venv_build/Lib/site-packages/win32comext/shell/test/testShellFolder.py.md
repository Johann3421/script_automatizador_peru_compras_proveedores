# Documentación Técnica: `venv_build/Lib/site-packages/win32comext/shell/test/testShellFolder.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32comext/shell/test/testShellFolder.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 21
