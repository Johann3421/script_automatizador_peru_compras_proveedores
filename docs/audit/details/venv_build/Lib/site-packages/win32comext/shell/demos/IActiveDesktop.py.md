# Documentación Técnica: `venv_build/Lib/site-packages/win32comext/shell/demos/IActiveDesktop.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/win32comext/shell/demos/IActiveDesktop.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 83
