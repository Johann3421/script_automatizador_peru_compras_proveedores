# Documentación Técnica: `venv_build/Lib/site-packages/greenlet/tests/fail_switch_three_greenlets.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/greenlet/tests/fail_switch_three_greenlets.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 44
