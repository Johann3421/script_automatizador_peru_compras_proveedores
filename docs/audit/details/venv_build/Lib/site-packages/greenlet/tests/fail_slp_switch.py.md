# Documentación Técnica: `venv_build/Lib/site-packages/greenlet/tests/fail_slp_switch.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/greenlet/tests/fail_slp_switch.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 29
