# Documentación Técnica: `venv_build/Lib/site-packages/customtkinter/windows/widgets/font/__init__.py`

- **Ruta relativa:** `venv_build/Lib/site-packages/customtkinter/windows/widgets/font/__init__.py`
- **Tipo de archivo:** `.py`
- **Líneas de código:** 24
